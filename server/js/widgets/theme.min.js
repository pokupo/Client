 ...
 */
;(function(d,l,o,h){if(d.ui.fancytree&&d.ui.fancytree.version){d.ui.fancytree.warn("Fancytree: ignored duplicate include");return}function u(i){i=i||"";d.error("Not implemented: "+i)}function m(i,B){if(!i){B=B?": "+B:"";d.error("Assertion failed"+B)}}function w(F,B){var C,E,D=l.console?l.console[F]:null;if(D){if(D.apply){D.apply(l.console,B)}else{E="";for(C=0;C<B.length;C++){E+=B[C]}D(E)}}}function c(i){return !!(i.tree&&i.statusNodeType!==h)}function n(G,F,E,C){var D,H,J,I=d.map(d.trim(G).split("."),function(i){return parseInt(i,10)}),B=d.map(Array.prototype.slice.call(arguments,1),function(i){return parseInt(i,10)});for(D=0;D<B.length;D++){H=I[D]||0;J=B[D]||0;if(H!==J){return(H>J)}}return true}function v(B,i,E,F,D){var C=(function(){var G=i[B],I=F[B],J=i.ext[D],H=function(){return G.apply(i,arguments)};return function(){var L=i._local,K=i._super;try{i._local=J;i._super=H;return I.apply(i,arguments)}finally{i._local=L;i._super=K}}})();return C}function e(i,D,E,C){for(var B in E){if(typeof E[B]==="function"){if(typeof i[B]==="function"){i[B]=v(B,i,D,E,C)}else{if(B.charAt(0)==="_"){i.ext[C][B]=v(B,i,D,E,C)}else{d.error("Could not override tree."+B+". Use prefix '_' to create tree."+C+"._"+B)}}}else{if(B!=="options"){i.ext[C][B]=E[B]}}}}function z(B,i){if(B===h){return d.Deferred(function(){this.resolve()}).promise()}else{return d.Deferred(function(){this.resolveWith(B,i)}).promise()}}function q(B,i){if(B===h){return d.Deferred(function(){this.reject()}).promise()}else{return d.Deferred(function(){this.rejectWith(B,i)}).promise()}}function t(i,B){return function(){i.resolveWith(B)}}function x(B){var C=d.extend({},B.data()),i=C.json;delete C.fancytree;if(i){delete C.json;C=d.extend(C,i)}return C}function y(i){i=i.toLowerCase();return function(B){return B.title.toLowerCase().indexOf(i)>=0}}var r,a=null,f={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","/":"&#x2F;"},A="active expanded focus folder hideCheckbox lazy selected unselectable".split(" "),g={},p="expanded extraClasses folder hideCheckbox key lazy refKey selected title tooltip unselectable".split(" "),k={},s={active:true,children:true,data:true,focus:true};for(r=0;r<A.length;r++){g[A[r]]=true}for(r=0;r<p.length;r++){k[p[r]]=true}function b(F,G){var E,C,D,B;this.parent=F;this.tree=F.tree;this.ul=null;this.li=null;this.statusNodeType=null;this._isLoading=false;this._error=null;this.data={};for(E=0,C=p.length;E<C;E++){D=p[E];this[D]=G[D]}if(G.data){d.extend(this.data,G.data)}for(D in G){if(!k[D]&&!d.isFunction(G[D])&&!s[D]){this.data[D]=G[D]}}if(this.key==null){if(this.tree.options.defaultKey){this.key=this.tree.options.defaultKey(this);m(this.key,"defaultKey() must return a unique key")}else{this.key="_"+(a._nextNodeKey++)}}else{this.key=""+this.key}if(G.active){m(this.tree.activeNode===null,"only one active node allowed");this.tree.activeNode=this}if(G.selected){this.tree.lastSelectedNode=this}this.children=null;B=G.children;if(B&&B.length){this._setChildren(B)}this.tree._callHook("treeRegisterNode",this.tree,true,this)}b.prototype={_findDirectChild:function(E){var D,C,B=this.children;if(B){if(typeof E==="string"){for(D=0,C=B.length;D<C;D++){if(B[D].key===E){return B[D]}}}else{if(typeof E==="number"){return this.children[E]}else{if(E.parent===this){return E}}}}return null},_setChildren:function(D){m(D&&(!this.children||this.children.length===0),"only init supported");this.children=[];for(var C=0,B=D.length;C<B;C++){this.children.push(new b(this,D[C]))}},addChildren:function(F,D){var E,B,H,G=null,C=[];if(d.isPlainObject(F)){F=[F]}if(!this.children){this.children=[]}for(E=0,B=F.length;E<B;E++){C.push(new b(this,F[E]))}G=C[0];if(D==null){this.children=this.children.concat(C)}else{D=this._findDirectChild(D);H=d.inArray(D,this.children);m(H>=0,"insertBefore must be an existing child");this.children.splice.apply(this.children,[H,0].concat(C))}if(!this.parent||this.parent.ul||this.tr){this.render()}if(this.tree.options.selectMode===3){this.fixSelection3FromEndNodes()}return G},addNode:function(i,B){if(B===h||B==="over"){B="child"}switch(B){case"after":return this.getParent().addChildren(i,this.getNextSibling());case"before":return this.getParent().addChildren(i,this);case"child":case"over":return this.addChildren(i)}m(false,"Invalid mode: "+B)},appendSibling:function(i){return this.addNode(i,"after")},applyPatch:function(E){if(E===null){this.remove();return z(this)}var B,D,i,C={children:true,expanded:true,parent:true};for(B in E){i=E[B];if(!C[B]&&!d.isFunction(i)){if(k[B]){this[B]=i}else{this.data[B]=i}}}if(E.hasOwnProperty("children")){this.removeChildren();if(E.children){this._setChildren(E.children)}}if(this.isVisible()){this.renderTitle();this.renderStatus()}if(E.hasOwnProperty("expanded")){D=this.setExpanded(E.expanded)}else{D=z(this)}return D},collapseSiblings:function(){return this.tree._callHook("nodeCollapseSiblings",this)},copyTo:function(i,C,B){return i.addNode(this.toDict(true,B),C)},countChildren:function(D){var C=this.children,E,B,F;if(!C){return 0}F=C.length;if(D!==false){for(E=0,B=F;E<B;E++){F+=C[E].countChildren()}}return F},debug:function(i){if(this.tree.options.debugLevel>=2){Array.prototype.unshift.call(arguments,this.toString());w("debug",arguments)}},discard:function(){this.warn("FancytreeNode.discard() is deprecated since 2014-02-16. Use .resetLazy() instead.");return this.resetLazy()},findAll:function(i){i=d.isFunction(i)?i:y(i);var B=[];this.visit(function(C){if(i(C)){B.push(C)}});return B},findFirst:function(i){i=d.isFunction(i)?i:y(i);var B=null;this.visit(function(C){if(i(C)){B=C;return false}});return B},_changeSelectStatusAttrs:function(i){var B=false;switch(i){case false:B=(this.selected||this.partsel);this.selected=false;this.partsel=false;break;case true:B=(!this.selected||!this.partsel);this.selected=true;this.partsel=true;break;case h:B=(this.selected||!this.partsel);this.selected=false;this.partsel=true;break;default:m(false,"invalid state: "+i)}if(B){this.renderStatus()}return B},fixSelection3AfterClick:function(){var i=this.isSelected();this.visit(function(B){B._changeSelectStatusAttrs(i)});this.fixSelection3FromEndNodes()},fixSelection3FromEndNodes:function(){m(this.tree.options.selectMode===3,"expected selectMode 3");function i(E){var H,F,D,J,B,I,G,C=E.children;if(C&&C.length){I=true;G=false;for(H=0,F=C.length;H<F;H++){D=C[H];J=i(D);if(J!==false){G=true}if(J!==true){I=false}}B=I?true:(G?h:false)}else{B=!!E.selected}E._changeSelectStatusAttrs(B);return B}i(this);this.visitParents(function(G){var F,C,I,H,E=G.children,D=true,B=false;for(F=0,C=E.length;F<C;F++){I=E[F];if(I.selected||I.partsel){B=true}if(!I.unselectable&&!I.selected){D=false}}H=D?true:(B?h:false);G._changeSelectStatusAttrs(H)})},fromDict:function(B){for(var i in B){if(k[i]){this[i]=B[i]}else{if(i==="data"){d.extend(this.data,B.data)}else{if(!d.isFunction(B[i])&&!s[i]){this.data[i]=B[i]}}}}if(B.children){this.removeChildren();this.addChildren(B.children)}this.renderTitle()},getChildren:function(){if(this.hasChildren()===h){return h}return this.children},getFirstChild:function(){return this.children?this.children[0]:null},getIndex:function(){return d.inArray(this,this.parent.children)},getIndexHier:function(B){B=B||".";var i=[];d.each(this.getParentList(false,true),function(C,D){i.push(D.getIndex()+1)});return i.join(B)},getKeyPath:function(C){var B=[],i=this.tree.options.keyPathSeparator;this.visitParents(function(D){if(D.parent){B.unshift(D.key)}},!C);return i+B.join(i)},getLastChild:function(){return this.children?this.children[this.children.length-1]:null},getLevel:function(){var B=0,i=this.parent;while(i){B++;i=i.parent}return B},getNextSibling:function(){if(this.parent){var C,B,D=this.parent.children;for(C=0,B=D.length-1;C<B;C++){if(D[C]===this){return D[C+1]}}}return null},getParent:function(){return this.parent},getParentList:function(B,C){var i=[],D=C?this:this.parent;while(D){if(B||D.parent){i.unshift(D)}D=D.parent}return i},getPrevSibling:function(){if(this.parent){var C,B,D=this.parent.children;for(C=1,B=D.length;C<B;C++){if(D[C]===this){return D[C-1]}}}return null},hasChildren:function(){if(this.lazy){if(this.children==null){return h}else{if(this.children.length===0){return false}else{if(this.children.length===1&&this.children[0].isStatusNode()){return h}}}return true}return !!this.children},hasFocus:function(){return(this.tree.hasFocus()&&this.tree.focusNode===this)},info:function(i){if(this.tree.options.debugLevel>=1){Array.prototype.unshift.call(arguments,this.toString());w("info",arguments)}},isActive:function(){return(this.tree.activeNode===this)},isChildOf:function(i){return(this.parent&&this.parent===i)},isDescendantOf:function(i){if(!i||i.tree!==this.tree){return false}var B=this.parent;while(B){if(B===i){return true}B=B.parent}return false},isExpanded:function(){return !!this.expanded},isFirstSibling:function(){var i=this.parent;return !i||i.children[0]===this},isFolder:function(){return !!this.folder},isLastSibling:function(){var i=this.parent;return !i||i.children[i.children.length-1]===this},isLazy:function(){return !!this.lazy},isLoaded:function(){return !this.lazy||this.hasChildren()!==h},isLoading:function(){return !!this._isLoading},isRoot:function(){return(this.tree.rootNode===this)},isSelected:function(){return !!this.selected},isStatusNode:function(){return !!this.statusNodeType},isUndefined:function(){return this.hasChildren()===h},isVisible:function(){var D,B,C=this.getParentList(false,false);for(D=0,B=C.length;D<B;D++){if(!C[D].expanded){return false}}return true},lazyLoad:function(i){this.warn("FancytreeNode.lazyLoad() is deprecated since 2014-02-16. Use .load() instead.");return this.load(i)},load:function(D){var i,C,B=this;m(this.isLazy(),"load() requires a lazy node");m(D||this.isUndefined(),"Pass forceReload=true to re-load a lazy node");if(this.isLoaded()){this.resetLazy()}C=this.tree._triggerNodeEvent("lazyLoad",this);if(C===false){return z(this)}m(typeof C!=="boolean","lazyLoad event must return source in data.result");i=this.tree._callHook("nodeLoadChildren",this,C);if(this.expanded){i.always(function(){B.render()})}return i},makeVisible:function(B){var D,E=this,J=[],I=new d.Deferred(),H=this.getParentList(false,false),F=H.length,C=!(B&&B.noAnimation===true),G=!(B&&B.scrollIntoView===false);for(D=F-1;D>=0;D--){J.push(H[D].setExpanded(true,B))}d.when.apply(d,J).done(function(){if(G){E.scrollIntoView(C).done(function(){I.resolve()})}else{I.resolve()}});return I.promise()},moveTo:function(D,E,C){if(E===h||E==="over"){E="child"}var F,i=this.parent,B=(E==="child")?D:D.parent;if(this===D){return}else{if(!this.parent){throw"Cannot move system root"}else{if(B.isDescendantOf(this)){throw"Cannot move a node to its own descendant"}}}if(this.parent.children.length===1){if(this.parent===B){return}this.parent.children=this.parent.lazy?[]:null;this.parent.expanded=false}else{F=d.inArray(this,this.parent.children);m(F>=0);this.parent.children.splice(F,1)}this.parent=B;if(B.hasChildren()){switch(E){case"child":B.children.push(this);break;case"before":F=d.inArray(D,B.children);m(F>=0);B.children.splice(F,0,this);break;case"after":F=d.inArray(D,B.children);m(F>=0);B.children.splice(F+1,0,this);break;default:throw"Invalid mode "+E}}else{B.children=[this]}if(C){D.visit(C,true)}if(this.tree!==D.tree){this.warn("Cross-tree moveTo is experimantal!");this.visit(function(G){G.tree=D.tree},true)}if(!i.isDescendantOf(B)){i.render()}if(!B.isDescendantOf(i)&&B!==i){B.render()}},navigate:function(E,H){var F,D,I=true,G=d.ui.keyCode,C=null;function B(J){if(J){try{J.makeVisible()}catch(i){}if(!d(J.span).is(":visible")){J.debug("Navigate: skipping hidden node");J.navigate(E,H);return}return H===false?J.setFocus():J.setActive()}}switch(E){case G.BACKSPACE:if(this.parent&&this.parent.parent){B(this.parent)}break;case G.LEFT:if(this.expanded){this.setExpanded(false);B(this)}else{if(this.parent&&this.parent.parent){B(this.parent)}}break;case G.RIGHT:if(!this.expanded&&(this.children||this.lazy)){this.setExpanded();B(this)}else{if(this.children&&this.children.length){B(this.children[0])}}break;case G.UP:C=this.getPrevSibling();while(C&&C.expanded&&C.children&&C.children.length){C=C.children[C.children.length-1]}if(!C&&this.parent&&this.parent.parent){C=this.parent}B(C);break;case G.DOWN:if(this.expanded&&this.children&&this.children.length){C=this.children[0]}else{D=this.getParentList(false,true);for(F=D.length-1;F>=0;F--){C=D[F].getNextSibling();if(C){break}}}B(C);break;default:I=false}},remove:function(){return this.parent.removeChild(this)},removeChild:function(i){return this.tree._callHook("nodeRemoveChild",this,i)},removeChildren:function(){return this.tree._callHook("nodeRemoveChildren",this)},render:function(B,i){return this.tree._callHook("nodeRender",this,B,i)},renderTitle:function(){return this.tree._callHook("nodeRenderTitle",this)},renderStatus:function(){return this.tree._callHook("nodeRenderStatus",this)},resetLazy:function(){this.removeChildren();this.expanded=false;this.lazy=true;this.children=h;this.renderStatus()},scheduleAction:function(C,B){if(this.tree.timer){clearTimeout(this.tree.timer)}this.tree.timer=null;var i=this;switch(C){case"cancel":break;case"expand":this.tree.timer=setTimeout(function(){i.tree.debug("setTimeout: trigger expand");i.setExpanded(true)},B);break;case"activate":this.tree.timer=setTimeout(function(){i.tree.debug("setTimeout: trigger activate");i.setActive(true)},B);break;default:throw"Invalid mode "+C}},scrollIntoView:function(P,C){if(C!==h&&c(C)){this.warn("scrollIntoView() with 'topNode' option is deprecated since 2014-05-08. Use 'options.topNode' instead.");C={topNode:C}}var S,D,E,J,K=d.extend({effects:(P===true)?{duration:200,queue:false}:P,scrollOfs:this.tree.options.scrollOfs,scrollParent:this.tree.options.scrollParent||this.tree.$container,topNode:null},C),Q=new d.Deferred(),G=this,F=d(this.span).height(),O=d(K.scrollParent),H=K.scrollOfs.top||0,I=K.scrollOfs.bottom||0,L=O.height(),i=O.scrollTop(),R=O,M=O[0]===l,B=K.topNode||null,N=null;m(d(this.span).is(":visible"),"scrollIntoView node is invisible");if(M){D=d(this.span).offset().top;S=B?d(B.span).offset().top:0;R=d("html,body")}else{m(O[0]!==o&&O[0]!==o.body,"scrollParent should be an simple element or `window`, not document or body.");J=O.offset().top,D=d(this.span).offset().top-J+i;S=B?d(B.span).offset().top-J+i:0;E=Math.max(0,(O.innerHeight()-O[0].clientHeight));L-=E}if(D<(i+H)){N=D-H}else{if((D+F)>(i+L-I)){N=D+F-L+I;if(B){m(d(B.span).is(":visible"));if(S<N){N=S-H}}}}if(N!==null){if(K.effects){K.effects.complete=function(){Q.resolveWith(G)};R.stop(true).animate({scrollTop:N},K.effects)}else{R[0].scrollTop=N;Q.resolveWith(this)}}else{Q.resolveWith(this)}return Q.promise()},setActive:function(i,B){return this.tree._callHook("nodeSetActive",this,i,B)},setExpanded:function(i,B){return this.tree._callHook("nodeSetExpanded",this,i,B)},setFocus:function(i){return this.tree._callHook("nodeSetFocus",this,i)},setSelected:function(i){return this.tree._callHook("nodeSetSelected",this,i)},setStatus:function(i,C,B){return this.tree._callHook("nodeSetStatus",this,i,C,B)},setTitle:function(i){this.title=i;this.renderTitle()},sortChildren:function(F,D){var E,C,B=this.children;if(!B){return}F=F||function(H,G){var i=H.title.toLowerCase(),I=G.title.toLowerCase();return i===I?0:i>I?1:-1};B.sort(F);if(D){for(E=0,C=B.length;E<C;E++){if(B[E].children){B[E].sortChildren(F,"$norender$")}}}if(D!=="$norender$"){this.render()}},toDict:function(D,H){var E,B,F,G={},C=this;d.each(p,function(J,I){if(C[I]||C[I]===false){G[I]=C[I]}});if(!d.isEmptyObject(this.data)){G.data=d.extend({},this.data);if(d.isEmptyObject(G.data)){delete G.data}}if(H){H(G)}if(D){if(this.hasChildren()){G.children=[];for(E=0,B=this.children.length;E<B;E++){F=this.children[E];if(!F.isStatusNode()){G.children.push(F.toDict(true,H))}}}else{}}return G},toggleExpanded:function(){return this.tree._callHook("nodeToggleExpanded",this)},toggleSelected:function(){return this.tree._callHook("nodeToggleSelected",this)},toString:function(){return"<FancytreeNode(#"+this.key+", '"+this.title+"')>"},visit:function(G,C){var F,B,E=true,D=this.children;if(C===true){E=G(this);if(E===false||E==="skip"){return E}}if(D){for(F=0,B=D.length;F<B;F++){E=D[F].visit(G,true);if(E===false){break}}}return E},visitParents:function(B,i){if(i&&B(this)===false){return false}var C=this.parent;while(C){if(B(C)===false){return false}C=C.parent}return true},warn:function(i){Array.prototype.unshift.call(arguments,this.toString());w("warn",arguments)}};function j(C){this.widget=C;this.$div=C.element;this.options=C.options;if(this.options&&d.isFunction(this.options.lazyload)){if(!d.isFunction(this.options.lazyLoad)){this.options.lazyLoad=function(){a.warn("The 'lazyload' event is deprecated since 2014-02-25. Use 'lazyLoad' (with uppercase L) instead.");C.options.lazyload.apply(this,arguments)}}}if(this.options&&d.isFunction(this.options.loaderror)){d.error("The 'loaderror' event was renamed since 2014-07-03. Use 'loadError' (with uppercase E) instead.")}this.ext={};this.data=x(this.$div);this._id=d.ui.fancytree._nextId++;this._ns=".fancytree-"+this._id;this.activeNode=null;this.focusNode=null;this._hasFocus=null;this.lastSelectedNode=null;this.systemFocusElement=null;this.statusClassPropName="span";this.ariaPropName="li";this.nodeContainerAttrName="li";this.$div.find(">ul.fancytree-container").remove();var i={tree:this},B;this.rootNode=new b(i,{title:"root",key:"root_"+this._id,children:null,expanded:true});this.rootNode.parent=null;B=d("<ul>",{"class":"ui-fancytree fancytree-container"}).appendTo(this.$div);this.$container=B;this.rootNode.ul=B[0];if(this.options.debugLevel==null){this.options.debugLevel=a.debugLevel}this.$container.attr("tabindex",this.options.tabbable?"0":"-1");if(this.options.aria){this.$container.attr("role","tree").attr("aria-multiselectable",true)}}j.prototype={_makeHookContext:function(E,C,B){var D,i;if(E.node!==h){if(C&&E.originalEvent!==C){d.error("invalid args")}D=E}else{if(E.tree){i=E.tree;D={node:E,tree:i,widget:i.widget,options:i.widget.options,originalEvent:C}}else{if(E.widget){D={node:null,tree:E,widget:E.widget,options:E.widget.options,originalEvent:C}}else{d.error("invalid args")}}}if(B){d.extend(D,B)}return D},_callHook:function(F,E,C){var i=this._makeHookContext(E),D=this[F],B=Array.prototype.slice.call(arguments,2);if(!d.isFunction(D)){d.error("_callHook('"+F+"') is not a function")}B.unshift(i);return D.apply(this,B)},_requireExtension:function(i,F,G,I){G=!!G;var B=this._local.name,D=this.options.extensions,C=d.inArray(i,D)<d.inArray(B,D),H=F&&this.ext[i]==null,E=!H&&G!=null&&(G!==C);m(B&&B!==i);if(H||E){if(!I){if(H||F){I="'"+B+"' extension requires '"+i+"'";if(E){I+=" to be registered "+(G?"before":"after")+" itself"}}else{I="If used together, `"+i+"` must be registered "+(G?"before":"after")+" `"+B+"`"}}d.error(I);return false}return true},activateKey:function(i){var B=this.getNodeByKey(i);if(B){B.setActive()}else{if(this.activeNode){this.activeNode.setActive(false)}}return B},applyPatch:function(C){var J,G,H,I,D,E,B=C.length,F=[];for(G=0;G<B;G++){H=C[G];m(H.length===2,"patchList must be an array of length-2-arrays");I=H[0];D=H[1];E=(I===null)?this.rootNode:this.getNodeByKey(I);if(E){J=new d.Deferred();F.push(J);E.applyPatch(D).always(t(J,E))}else{this.warn("could not find node with key '"+I+"'")}}return d.when.apply(d,F).promise()},count:function(){return this.rootNode.countChildren()},debug:function(i){if(this.options.debugLevel>=2){Array.prototype.unshift.call(arguments,this.toString());w("debug",arguments)}},generateFormElements:function(D,F){var B,C=(D!==false)?"ft_"+this._id+"[]":D,E=(F!==false)?"ft_"+this._id+"_active":F,G="fancytree_result_"+this._id,i=d("#"+G);if(i.length){i.empty()}else{i=d("<div>",{id:G}).hide().insertAfter(this.$container)}if(C){B=this.getSelectedNodes(this.options.selectMode===3);d.each(B,function(H,I){i.append(d("<input>",{type:"checkbox",name:C,value:I.key,checked:true}))})}if(E&&this.activeNode){i.append(d("<input>",{type:"radio",name:E,value:this.activeNode.key,checked:true}))}},getActiveNode:function(){return this.activeNode},getFirstChild:function(){return this.rootNode.getFirstChild()},getFocusNode:function(i){return this.focusNode},getNodeByKey:function(B,D){var C,i;if(!D){C=o.getElementById(this.options.idPrefix+B);if(C){return C.ftnode?C.ftnode:null}}D=D||this.rootNode;i=null;D.visit(function(E){if(E.key===B){i=E;return false}},true);return i},getRootNode:function(){return this.rootNode},getSelectedNodes:function(i){var B=[];this.rootNode.visit(function(C){if(C.selected){B.push(C);if(i===true){return"skip"}}});return B},hasFocus:function(){return !!this._hasFocus},info:function(i){if(this.options.debugLevel>=1){Array.prototype.unshift.call(arguments,this.toString());w("info",arguments)}},loadKeyPath:function(I,L,E){var G,M,H,P,K,F,D,C,J=E||this.rootNode,O=this.options.keyPathSeparator,N=this;if(!d.isArray(I)){I=[I]}F={};for(H=0;H<I.length;H++){P=I[H];if(P.charAt(0)===O){P=P.substr(1)}C=P.split(O);while(C.length){K=C.shift();D=J._findDirectChild(K);if(!D){this.warn("loadKeyPath: key not found: "+K+" (parent: "+J+")");L.call(this,K,"error");break}else{if(C.length===0){L.call(this,D,"ok");break}else{if(!D.lazy||(D.hasChildren()!==h)){L.call(this,D,"loaded");J=D}else{L.call(this,D,"loaded");if(F[K]){F[K].push(C.join(O))}else{F[K]=[C.join(O)]}break}}}}}G=[];function B(Q,R,i){L.call(N,R,"loading");R.load().done(function(){N.loadKeyPath.call(N,F[Q],L,R).always(t(i,N))}).fail(function(S){N.warn("loadKeyPath: error loading: "+Q+" (parent: "+J+")");L.call(N,R,"error");i.reject()})}for(K in F){D=J._findDirectChild(K);M=new d.Deferred();G.push(M);B(K,D,M)}return d.when.apply(d,G).promise()},reactivate:function(i){var B=this.activeNode;if(B){this.activeNode=null;B.setActive();if(i){B.setFocus()}}},reload:function(i){this._callHook("treeClear",this);return this._callHook("treeLoad",this,i)},render:function(B,i){return this.rootNode.render(B,i)},setFocus:function(i){return this._callHook("treeSetFocus",this,i)},toDict:function(i,C){var B=this.rootNode.toDict(true,C);return i?B:B.children},toString:function(){return"<Fancytree(#"+this._id+")>"},_triggerNodeEvent:function(E,F,B,i){var C=this._makeHookContext(F,B,i),D=this.widget._trigger(E,B,C);if(D!==false&&C.result!==h){return C.result}return D},_triggerTreeEvent:function(D,i){var B=this._makeHookContext(this,i),C=this.widget._trigger(D,i,B);if(C!==false&&B.result!==h){return B.result}return C},visit:function(i){return this.rootNode.visit(i,false)},warn:function(i){Array.prototype.unshift.call(arguments,this.toString());w("warn",arguments)}};d.extend(j.prototype,{nodeClick:function(i){var C,B,E=i.originalEvent,F=i.targetType,D=i.node;if(F==="expander"){this._callHook("nodeToggleExpanded",i)}else{if(F==="checkbox"){this._callHook("nodeToggleSelected",i);this._callHook("nodeSetFocus",i,true)}else{B=false;C=true;if(D.folder){switch(i.options.clickFolderMode){case 2:B=true;C=false;break;case 3:C=true;B=true;break}}if(C){this.nodeSetFocus(i);this._callHook("nodeSetActive",i,true)}if(B){if(!C){}this._callHook("nodeToggleExpanded",i)}}}if(E.target.localName==="a"&&E.target.className==="fancytree-title"){E.preventDefault()}},nodeCollapseSiblings:function(D,B){var G,E,C,F=D.node;if(F.parent){G=F.parent.children;for(E=0,C=G.length;E<C;E++){if(G[E]!==F&&G[E].expanded){this._callHook("nodeSetExpanded",G[E],false,B)}}}},nodeDblclick:function(i){if(i.targetType==="title"&&i.options.clickFolderMode===4){this._callHook("nodeToggleExpanded",i)}if(i.targetType==="title"){i.originalEvent.preventDefault()}},nodeKeydown:function(G){var F,B=G.originalEvent,C=G.node,I=G.tree,i=G.options,E=true,D=!(B.ctrlKey||!i.autoActivate),H=d.ui.keyCode;if(!C){this.rootNode.getFirstChild().setFocus();C=G.node=this.focusNode;C.debug("Keydown force focus on first node")}switch(B.which){case H.NUMPAD_ADD:case 187:I.nodeSetExpanded(G,true);break;case H.NUMPAD_SUBTRACT:case 189:I.nodeSetExpanded(G,false);break;case H.SPACE:if(i.checkbox){I.nodeToggleSelected(G)}else{I.nodeSetActive(G,true)}break;case H.ENTER:I.nodeSetActive(G,true);break;case H.BACKSPACE:case H.LEFT:case H.RIGHT:case H.UP:case H.DOWN:F=C.navigate(B.which,D);break;default:E=false}if(E){B.preventDefault()}},nodeLoadChildren:function(C,G){var F,D,B,i=C.tree,E=C.node;if(d.isFunction(G)){G=G()}if(G.url){F=d.extend({},C.options.ajax,G);if(F.debugDelay){D=F.debugDelay;if(d.isArray(D)){D=D[0]+Math.random()*(D[1]-D[0])}E.debug("nodeLoadChildren waiting debug delay "+Math.round(D)+"ms");F.debugDelay=false;B=d.Deferred(function(H){setTimeout(function(){d.ajax(F).done(function(){H.resolveWith(this,arguments)}).fail(function(){H.rejectWith(this,arguments)})},D)})}else{B=d.ajax(F)}G=new d.Deferred();B.done(function(K,L,J){var I,H;if(typeof K==="string"){d.error("Ajax request returned a string (did you get the JSON dataType wrong?).")}if(C.options.postProcess){H=i._triggerNodeEvent("postProcess",C,C.originalEvent,{response:K,error:null,dataType:this.dataType});if(H.error){I=d.isPlainObject(H.error)?H.error:{message:H.error};I=i._makeHookContext(E,null,I);G.rejectWith(this,[I]);return}K=d.isArray(H)?H:K}else{if(K&&K.hasOwnProperty("d")&&C.options.enableAspx){K=(typeof K.d==="string")?d.parseJSON(K.d):K.d}}G.resolveWith(this,[K])}).fail(function(I,K,J){var H=i._makeHookContext(E,null,{error:I,args:Array.prototype.slice.call(arguments),message:J,details:I.status+": "+J});G.rejectWith(this,[H])})}if(d.isFunction(G.promise)){m(!E.isLoading());i.nodeSetStatus(C,"loading");G.done(function(H){i.nodeSetStatus(C,"ok")}).fail(function(H){var I;if(H.node&&H.error&&H.message){I=H}else{I=i._makeHookContext(E,null,{error:H,args:Array.prototype.slice.call(arguments),message:H?(H.message||H.toString()):""})}if(i._triggerNodeEvent("loadError",I,null)!==false){i.nodeSetStatus(C,"error",I.message,I.details)}})}return d.when(G).done(function(I){var H;if(d.isPlainObject(I)){m(d.isArray(I.children),"source must contain (or be) an array of children");m(E.isRoot(),"source may only be an object for root nodes");H=I;I=I.children;delete H.children;d.extend(i.data,H)}m(d.isArray(I),"expected array of children");E._setChildren(I);i._triggerNodeEvent("loadChildren",E)})},nodeLoadKeyPath:function(i,B){},nodeRemoveChild:function(B,D){var i,G=B.node,F=B.options,E=d.extend({},B,{node:D}),C=G.children;if(C.length===1){m(D===C[0]);return this.nodeRemoveChildren(B)}if(this.activeNode&&(D===this.activeNode||this.activeNode.isDescendantOf(D))){this.activeNode.setActive(false)}if(this.focusNode&&(D===this.focusNode||this.focusNode.isDescendantOf(D))){this.focusNode=null}this.nodeRemoveMarkup(E);this.nodeRemoveChildren(E);i=d.inArray(D,C);m(i>=0);D.visit(function(H){H.parent=null},true);this._callHook("treeRegisterNode",this,false,D);if(F.removeNode){F.removeNode.call(B.tree,{type:"removeNode"},E)}C.splice(i,1)},nodeRemoveChildMarkup:function(i){var B=i.node;if(B.ul){if(B.isRoot()){d(B.ul).empty()}else{d(B.ul).remove();B.ul=null}B.visit(function(C){C.li=C.ul=null})}},nodeRemoveChildren:function(B){var F,i=B.tree,E=B.node,C=E.children,D=B.options;if(!C){return}if(this.activeNode&&this.activeNode.isDescendantOf(E)){this.activeNode.setActive(false)}if(this.focusNode&&this.focusNode.isDescendantOf(E)){this.focusNode=null}this.nodeRemoveChildMarkup(B);F=d.extend({},B);E.visit(function(G){G.parent=null;i._callHook("treeRegisterNode",i,false,G);if(D.removeNode){F.node=G;D.removeNode.call(B.tree,{type:"removeNode"},F)}});if(E.lazy){E.children=[]}else{E.children=null}this.nodeRenderStatus(B)},nodeRemoveMarkup:function(i){var B=i.node;if(B.li){d(B.li).remove();B.li=null}this.nodeRemoveChildMarkup(i)},nodeRender:function(Q,B,S,F,D){var G,K,J,T,R,N,U,P=Q.node,M=Q.tree,L=Q.options,C=L.aria,H=false,I=P.parent,O=!I,E=P.children;if(!O&&!I.ul){return}m(O||I.ul,"parent UL must exist");if(!O){if(P.li&&(B||(P.li.parentNode!==P.parent.ul))){if(P.li.parentNode!==P.parent.ul){this.warn("unlink "+P+" (must be child of "+P.parent+")")}this.nodeRemoveMarkup(Q)}if(!P.li){H=true;P.li=o.createElement("li");P.li.ftnode=P;if(C){}if(P.key&&L.generateIds){P.li.id=L.idPrefix+P.key}P.span=o.createElement("span");P.span.className="fancytree-node";if(C){d(P.span).attr("aria-labelledby","ftal_"+P.key)}P.li.appendChild(P.span);this.nodeRenderTitle(Q);if(L.createNode){L.createNode.call(M,{type:"createNode"},Q)}}else{this.nodeRenderStatus(Q)}if(L.renderNode){L.renderNode.call(M,{type:"renderNode"},Q)}}if(E){if(O||P.expanded||S===true){if(!P.ul){P.ul=o.createElement("ul");if((F===true&&!D)||!P.expanded){P.ul.style.display="none"}if(C){d(P.ul).attr("role","group")}if(P.li){P.li.appendChild(P.ul)}else{P.tree.$div.append(P.ul)}}for(T=0,R=E.length;T<R;T++){U=d.extend({},Q,{node:E[T]});this.nodeRender(U,B,S,false,true)}G=P.ul.firstChild;while(G){J=G.ftnode;if(J&&J.parent!==P){P.debug("_fixParent: remove missing "+J,G);N=G.nextSibling;G.parentNode.removeChild(G);G=N}else{G=G.nextSibling}}G=P.ul.firstChild;for(T=0,R=E.length-1;T<R;T++){K=E[T];J=G.ftnode;if(K!==J){P.ul.insertBefore(K.li,J.li)}else{G=G.nextSibling}}}}else{if(P.ul){this.warn("remove child markup for "+P);this.nodeRemoveChildMarkup(Q)}}if(!O){if(H){I.ul.appendChild(P.li)}}},nodeRenderTitle:function(M,K){var C,L,H,G,F,O,D=M.node,N=M.tree,i=M.options,J=i.aria,B=D.getLevel(),E=[],I=D.data.icon;if(K!==h){D.title=K}if(!D.span){return}if(B<i.minExpandLevel){if(B>1){if(J){E.push("<span role='button' class='fancytree-expander'></span>")}else{E.push("<span class='fancytree-expander'></span>")}}}else{if(J){E.push("<span role='button' class='fancytree-expander'></span>")}else{E.push("<span class='fancytree-expander'></span>")}}if(i.checkbox&&D.hideCheckbox!==true&&!D.isStatusNode()){if(J){E.push("<span role='checkbox' class='fancytree-checkbox'></span>")}else{E.push("<span class='fancytree-checkbox'></span>")}}G=J?" role='img'":"";if(I&&typeof I==="string"){L=(I.charAt(0)==="/")?I:((i.imagePath||"")+I);E.push("<img src='"+L+"' class='fancytree-icon' alt='' />")}else{if(D.data.iconclass){E.push("<span "+G+" class='fancytree-custom-icon "+D.data.iconclass+"'></span>")}else{if(I===true||(I!==false&&i.icons!==false)){E.push("<span "+G+" class='fancytree-icon'></span>")}}}H="";if(i.renderTitle){H=i.renderTitle.call(N,{type:"renderTitle"},M)||""}if(!H){O=D.tooltip?" title='"+a.escapeHtml(D.tooltip)+"'":"";C=J?" id='ftal_"+D.key+"'":"";G=J?" role='treeitem'":"";F=i.titlesTabbable?" tabindex='0'":"";H="<span "+G+" class='fancytree-title'"+C+O+F+">"+D.title+"</span>"}E.push(H);D.span.innerHTML=E.join("");this.nodeRenderStatus(M)},nodeRenderStatus:function(J){var B=J.node,K=J.tree,i=J.options,D=B.hasChildren(),F=B.isLastSibling(),G=i.aria,C=d(B.span).find(".fancytree-title"),I=i._classNames,H=[],E=B[K.statusClassPropName];if(!E){return}H.push(I.node);if(K.activeNode===B){H.push(I.active)}if(K.focusNode===B){H.push(I.focused);if(G){C.attr("aria-activedescendant",true)}}else{if(G){C.removeAttr("aria-activedescendant")}}if(B.expanded){H.push(I.expanded);if(G){C.attr("aria-expanded",true)}}else{if(G){C.removeAttr("aria-expanded")}}if(B.folder){H.push(I.folder)}if(D!==false){H.push(I.hasChildren)}if(F){H.push(I.lastsib)}if(B.lazy&&B.children==null){H.push(I.lazy)}if(B.partsel){H.push(I.partsel)}if(B._isLoading){H.push(I.loading)}if(B._error){H.push(I.error)}if(B.selected){H.push(I.selected);if(G){C.attr("aria-selected",true)}}else{if(G){C.attr("aria-selected",false)}}if(B.extraClasses){H.push(B.extraClasses)}if(D===false){H.push(I.combinedExpanderPrefix+"n"+(F?"l":""))}else{H.push(I.combinedExpanderPrefix+(B.expanded?"e":"c")+(B.lazy&&B.children==null?"d":"")+(F?"l":""))}H.push(I.combinedIconPrefix+(B.expanded?"e":"c")+(B.folder?"f":""));E.className=H.join(" ");if(B.li){B.li.className=F?I.lastsib:""}},nodeSetActive:function(H,D,F){F=F||{};var C,B=H.node,I=H.tree,i=H.options,E=(F.noEvents===true),G=(B===I.activeNode);D=(D!==false);if(G===D){return z(B)}else{if(D&&!E&&this._triggerNodeEvent("beforeActivate",B,H.originalEvent)===false){return q(B,["rejected"])}}if(D){if(I.activeNode){m(I.activeNode!==B,"node was active (inconsistency)");C=d.extend({},H,{node:I.activeNode});I.nodeSetActive(C,false);m(I.activeNode===null,"deactivate was out of sync?")}if(i.activeVisible){B.makeVisible({scrollIntoView:false})}I.activeNode=B;I.nodeRenderStatus(H);I.nodeSetFocus(H);if(!E){I._triggerNodeEvent("activate",B,H.originalEvent)}}else{m(I.activeNode===B,"node was not active (inconsistency)");I.activeNode=null;this.nodeRenderStatus(H);if(!E){H.tree._triggerNodeEvent("deactivate",B,H.originalEvent)}}},nodeSetExpanded:function(N,I,L){L=L||{};var K,M,G,E,J,C,D=N.node,O=N.tree,B=N.options,F=(L.noAnimation===true),H=(L.noEvents===true);I=(I!==false);if((D.expanded&&I)||(!D.expanded&&!I)){return z(D)}else{if(I&&!D.lazy&&!D.hasChildren()){return z(D)}else{if(!I&&D.getLevel()<B.minExpandLevel){return q(D,["locked"])}else{if(!H&&this._triggerNodeEvent("beforeExpand",D,N.originalEvent)===false){return q(D,["rejected"])}}}}if(!F&&!D.isVisible()){F=L.noAnimation=true}M=new d.Deferred();if(I&&!D.expanded&&B.autoCollapse){J=D.getParentList(false,true);C=B.autoCollapse;try{B.autoCollapse=false;for(G=0,E=J.length;G<E;G++){this._callHook("nodeCollapseSiblings",J[G],L)}}finally{B.autoCollapse=C}}M.done(function(){if(I&&B.autoScroll&&!F){D.getLastChild().scrollIntoView(true,{topNode:D}).always(function(){if(!H){N.tree._triggerNodeEvent(I?"expand":"collapse",N)}})}else{if(!H){N.tree._triggerNodeEvent(I?"expand":"collapse",N)}}});K=function(S){var P,R,i,Q;D.expanded=I;O._callHook("nodeRender",N,false,false,true);if(D.ul){i=(D.ul.style.display!=="none");Q=!!D.expanded;if(i===Q){D.warn("nodeSetExpanded: UL.style.display already set")}else{if(!B.fx||F){D.ul.style.display=(D.expanded||!parent)?"":"none"}else{P=B.fx.duration||200;R=B.fx.easing;d(D.ul).animate(B.fx,P,R,function(){S()});return}}}S()};if(I&&D.lazy&&D.hasChildren()===h){D.load().done(function(){if(M.notifyWith){M.notifyWith(D,["loaded"])}K(function(){M.resolveWith(D)})}).fail(function(i){K(function(){M.rejectWith(D,["load failed ("+i+")"])})})}else{K(function(){M.resolveWith(D)})}return M.promise()},nodeSetFocus:function(D,C){var B,i=D.tree,E=D.node;C=(C!==false);if(i.focusNode){if(i.focusNode===E&&C){return}B=d.extend({},D,{node:i.focusNode});i.focusNode=null;this._triggerNodeEvent("blur",B);this._callHook("nodeRenderStatus",B)}if(C){if(!this.hasFocus()){E.debug("nodeSetFocus: forcing container focus");this._callHook("treeSetFocus",D,true,true)}E.makeVisible({scrollIntoView:false});i.focusNode=E;this._triggerNodeEvent("focus",D);if(D.options.autoScroll){E.scrollIntoView()}this._callHook("nodeRenderStatus",D)}},nodeSetSelected:function(C,B){var E=C.node,i=C.tree,D=C.options;B=(B!==false);E.debug("nodeSetSelected("+B+")",C);if(E.unselectable){return}if((E.selected&&B)||(!E.selected&&!B)){return !!E.selected}else{if(this._triggerNodeEvent("beforeSelect",E,C.originalEvent)===false){return !!E.selected}}if(B&&D.selectMode===1){if(i.lastSelectedNode){i.lastSelectedNode.setSelected(false)}}else{if(D.selectMode===3){E.selected=B;E.fixSelection3AfterClick()}}E.selected=B;this.nodeRenderStatus(C);i.lastSelectedNode=B?E:null;i._triggerNodeEvent("select",C)},nodeSetStatus:function(D,C,G,E){var F=D.node,i=D.tree;function H(){var J=(F.children?F.children[0]:null);if(J&&J.isStatusNode()){try{if(F.ul){F.ul.removeChild(J.li);J.li=null}}catch(I){}if(F.children.length===1){F.children=[]}else{F.children.shift()}}}function B(J,I){var K=(F.children?F.children[0]:null);if(K&&K.isStatusNode()){d.extend(K,J);i._callHook("nodeRender",K)}else{J.key="_statusNode";F._setChildren([J]);F.children[0].statusNodeType=I;i.render()}return F.children[0]}switch(C){case"ok":H();F._isLoading=false;F._error=null;F.renderStatus();break;case"loading":if(!F.parent){B({title:i.options.strings.loading+(G?" ("+G+") ":""),tooltip:E,extraClasses:"fancytree-statusnode-wait"},C)}F._isLoading=true;F._error=null;F.renderStatus();break;case"error":B({title:i.options.strings.loadError+(G?" ("+G+") ":""),tooltip:E,extraClasses:"fancytree-statusnode-error"},C);F._isLoading=false;F._error={message:G,details:E};F.renderStatus();break;default:d.error("invalid node status "+C)}},nodeToggleExpanded:function(i){return this.nodeSetExpanded(i,!i.node.expanded)},nodeToggleSelected:function(i){return this.nodeSetSelected(i,!i.node.selected)},treeClear:function(B){var i=B.tree;i.activeNode=null;i.focusNode=null;i.$div.find(">ul.fancytree-container").empty();i.rootNode.children=null},treeCreate:function(i){},treeDestroy:function(i){},treeInit:function(i){this.treeLoad(i)},treeLoad:function(D,G){var F,E,C=D.tree,H=D.widget.element,B,i=d.extend({},D,{node:this.rootNode});if(C.rootNode.children){this.treeClear(D)}G=G||this.options.source;if(!G){F=H.data("type")||"html";switch(F){case"html":E=H.find(">ul:first");E.addClass("ui-fancytree-source ui-helper-hidden");G=d.ui.fancytree.parseHtml(E);this.data=d.extend(this.data,x(E));break;case"json":G=d.parseJSON(H.text());if(G.children){if(G.title){C.title=G.title}G=G.children}break;default:d.error("Invalid data-type: "+F)}}else{if(typeof G==="string"){u()}}B=this.nodeLoadChildren(i,G).done(function(){C.render();if(D.options.selectMode===3){C.rootNode.fixSelection3FromEndNodes()}C._triggerTreeEvent("init",true)}).fail(function(){C.render();C._triggerTreeEvent("init",false)});return B},treeRegisterNode:function(i,C,B){},treeSetFocus:function(B,i,C){i=(i!==false);if(i!==this.hasFocus()){this._hasFocus=i;this.$container.toggleClass("fancytree-treefocus",i);this._triggerTreeEvent(i?"focusTree":"blurTree")}}});d.widget("ui.fancytree",{options:{activeVisible:true,ajax:{type:"GET",cache:false,dataType:"json"},aria:false,autoActivate:true,autoCollapse:false,autoScroll:false,checkbox:false,clickFolderMode:4,debugLevel:null,disabled:false,enableAspx:true,extensions:[],fx:{height:"toggle",duration:200},generateIds:false,icons:true,idPrefix:"ft_",keyboard:true,keyPathSeparator:"/",minExpandLevel:1,scrollOfs:{top:0,bottom:0},scrollParent:null,selectMode:2,strings:{loading:"Loading&#8230;",loadError:"Load error!"},tabbable:true,titlesTabbable:false,_classNames:{node:"fancytree-node",folder:"fancytree-folder",combinedExpanderPrefix:"fancytree-exp-",combinedIconPrefix:"fancytree-ico-",hasChildren:"fancytree-has-children",active:"fancytree-active",selected:"fancytree-selected",expanded:"fancytree-expanded",lazy:"fancytree-lazy",focused:"fancytree-focused",partsel:"fancytree-partsel",lastsib:"fancytree-lastsib",loading:"fancytree-loading",error:"fancytree-error"},lazyLoad:null,postProcess:null},_create:function(){this.tree=new j(this);this.$source=this.source||this.element.data("type")==="json"?this.element:this.element.find(">ul:first");var F,D,B,C=this.options.extensions,E=this.tree;for(B=0;B<C.length;B++){D=C[B];F=d.ui.fancytree._extensions[D];if(!F){d.error("Could not apply extension '"+D+"' (it is not registered, did you forget to include it?)")}this.tree.options[D]=d.extend(true,{},F.options,this.tree.options[D]);m(this.tree.ext[D]===h,"Extension name must not exist as Fancytree.ext attribute: '"+D+"'");this.tree.ext[D]={};e(this.tree,E,F,D);E=F}this.tree._callHook("treeCreate",this.tree)},_init:function(){this.tree._callHook("treeInit",this.tree);this._bind()},_setOption:function(i,C){var D=true,B=false;switch(i){case"aria":case"checkbox":case"icons":case"minExpandLevel":case"tabbable":this.tree._callHook("treeCreate",this.tree);B=true;break;case"source":D=false;this.tree._callHook("treeLoad",this.tree,C);break}this.tree.debug("set option "+i+"="+C+" <"+typeof(C)+">");if(D){d.Widget.prototype._setOption.apply(this,arguments)}if(B){this.tree.render(true,false)}},destroy:function(){this._unbind();this.tree._callHook("treeDestroy",this.tree);this.tree.$div.find(">ul.fancytree-container").remove();this.$source&&this.$source.removeClass("ui-helper-hidden");d.Widget.prototype.destroy.call(this)},_unbind:function(){var i=this.tree._ns;this.element.unbind(i);this.tree.$container.unbind(i);d(o).unbind(i)},_bind:function(){var D=this,C=this.options,i=this.tree,B=i._ns;this._unbind();i.$container.on("focusin"+B+" focusout"+B,function(G){var F=a.getNode(G),E=(G.type==="focusin");if(F){i._callHook("nodeSetFocus",F,E)}else{i._callHook("treeSetFocus",i,E)}}).on("selectstart"+B,"span.fancytree-title",function(E){E.preventDefault()}).on("keydown"+B,function(I){if(C.disabled||C.keyboard===false){return true}var G,H=i.focusNode,E=i._makeHookContext(H||i,I),F=i.phase;try{i.phase="userEvent";if(H){G=i._triggerNodeEvent("keydown",H,I)}else{G=i._triggerTreeEvent("keydown",I)}if(G==="preventNav"){G=true}else{if(G!==false){G=i._callHook("nodeKeydown",E)}}return G}finally{i.phase=F}}).on("click"+B+" dblclick"+B,function(I){if(C.disabled){return true}var F,J=a.getEventTarget(I),H=J.node,E=D.tree,G=E.phase;if(!H){return true}F=E._makeHookContext(H,I);try{E.phase="userEvent";switch(I.type){case"click":F.targetType=J.type;return(E._triggerNodeEvent("click",F,I)===false)?false:E._callHook("nodeClick",F);case"dblclick":F.targetType=J.type;return(E._triggerNodeEvent("dblclick",F,I)===false)?false:E._callHook("nodeDblclick",F)}}finally{E.phase=G}})},getActiveNode:function(){return this.tree.activeNode},getNodeByKey:function(i){return this.tree.getNodeByKey(i)},getRootNode:function(){return this.tree.rootNode},getTree:function(){return this.tree}});a=d.ui.fancytree;d.extend(d.ui.fancytree,{version:"2.3.0",buildType:"production",debugLevel:1,_nextId:1,_nextNodeKey:1,_extensions:{},_FancytreeClass:j,_FancytreeNodeClass:b,jquerySupports:{positionMyOfs:n(d.ui.version,1,9)},assert:function(i,B){return m(i,B)},debounce:function(C,B,D,i){var E;if(arguments.length===3&&typeof D!=="boolean"){i=D;D=false}return function(){var F=arguments;i=i||this;D&&!E&&B.apply(i,F);clearTimeout(E);E=setTimeout(function(){D||B.apply(i,F);E=null},C)}},debug:function(i){(d.ui.fancytree.debugLevel>=2)&&w("log",arguments)},error:function(i){w("error",arguments)},escapeHtml:function(i){return(""+i).replace(/[&<>"'\/]/g,function(B){return f[B]})},unescapeHtml:function(i){var B=o.createElement("div");B.innerHTML=i;return B.childNodes.length===0?"":B.childNodes[0].nodeValue},getEventTargetType:function(i){return this.getEventTarget(i).type},getEventTarget:function(B){var C=B&&B.target?B.target.className:"",i={node:this.getNode(B.target),type:h};if(/\bfancytree-title\b/.test(C)){i.type="title"}else{if(/\bfancytree-expander\b/.test(C)){i.type=(i.node.hasChildren()===false?"prefix":"expander")}else{if(/\bfancytree-checkbox\b/.test(C)||/\bfancytree-radio\b/.test(C)){i.type="checkbox"}else{if(/\bfancytree-icon\b/.test(C)){i.type="icon"}else{if(/\bfancytree-node\b/.test(C)){i.type="title"}else{if(B&&B.target&&d(B.target).closest(".fancytree-title").length){i.type="title"}}}}}}return i},getNode:function(i){if(i instanceof b){return i}else{if(i.selector!==h){i=i[0]}else{if(i.originalEvent!==h){i=i.target}}}while(i){if(i.ftnode){return i.ftnode}i=i.parentNode}return null},info:function(i){(d.ui.fancytree.debugLevel>=1)&&w("info",arguments)},parseHtml:function(J){var F,H,E,G,I,C,D,K,L=J.find(">li"),B=[];L.each(function(){var N,P=d(this),M=P.find(">span:first",this),i=M.length?null:P.find(">a:first"),O={tooltip:null,data:{}};if(M.length){O.title=M.html()}else{if(i&&i.length){O.title=i.html();O.data.href=i.attr("href");O.data.target=i.attr("target");O.tooltip=i.attr("title")}else{O.title=P.html();G=O.title.search(/<ul/i);if(G>=0){O.title=O.title.substring(0,G)}}}O.title=d.trim(O.title);for(H=0,E=A.length;H<E;H++){O[A[H]]=h}D=this.className.split(" ");F=[];for(H=0,E=D.length;H<E;H++){K=D[H];if(g[K]){O[K]=true}else{F.push(K)}}O.extraClasses=F.join(" ");I=P.attr("title");if(I){O.tooltip=I}I=P.attr("id");if(I){O.key=I}N=x(P);if(N&&!d.isEmptyObject(N)){for(H=0,E=p.length;H<E;H++){I=p[H];C=N[I];if(C!=null){delete N[I];O[I]=C}}d.extend(O.data,N)}J=P.find(">ul:first");if(J.length){O.children=d.ui.fancytree.parseHtml(J)}else{O.children=O.lazy?h:null}B.push(O)});return B},registerExtension:function(i){m(i.name!=null,"extensions must have a `name` property.");m(i.version!=null,"extensions must have a `version` property.");d.ui.fancytree._extensions[i.name]=i},warn:function(i){w("warn",arguments)}})}(jQuery,window,document));
/*!
 ...
 * @date 2014-08-17T10:39
 */
;(function(f,e,b,g){function d(i,j){if(!i){j=j?": "+j:"";f.error("Assertion failed"+j)}}function h(j,l){var k;for(k=j.length-1;k>=0;k--){if(j[k]===l){j.splice(k,1);return true}}return false}function c(r,p,n){var j,o,s=r.length&3,t=r.length-s,q=n,m=3432918353,k=461845907,l=0;while(l<t){o=((r.charCodeAt(l)&255))|((r.charCodeAt(++l)&255)<<8)|((r.charCodeAt(++l)&255)<<16)|((r.charCodeAt(++l)&255)<<24);++l;o=((((o&65535)*m)+((((o>>>16)*m)&65535)<<16)))&4294967295;o=(o<<15)|(o>>>17);o=((((o&65535)*k)+((((o>>>16)*k)&65535)<<16)))&4294967295;q^=o;q=(q<<13)|(q>>>19);j=((((q&65535)*5)+((((q>>>16)*5)&65535)<<16)))&4294967295;q=(((j&65535)+27492)+((((j>>>16)+58964)&65535)<<16))}o=0;switch(s){case 3:o^=(r.charCodeAt(l+2)&255)<<16;case 2:o^=(r.charCodeAt(l+1)&255)<<8;case 1:o^=(r.charCodeAt(l)&255);o=(((o&65535)*m)+((((o>>>16)*m)&65535)<<16))&4294967295;o=(o<<15)|(o>>>17);o=(((o&65535)*k)+((((o>>>16)*k)&65535)<<16))&4294967295;q^=o}q^=r.length;q^=q>>>16;q=(((q&65535)*2246822507)+((((q>>>16)*2246822507)&65535)<<16))&4294967295;q^=q>>>13;q=((((q&65535)*3266489909)+((((q>>>16)*3266489909)&65535)<<16)))&4294967295;q^=q>>>16;if(p){return("0000000"+(q>>>0).toString(16)).substr(-8)}return q>>>0}function a(j){var i,k=f.map(j.getParentList(false,true),function(l){return l.refKey||l.key});k=k.join("/");i="id_"+c(k,true);j.debug(k+" -> "+i);return i}f.ui.fancytree._FancytreeNodeClass.prototype.getCloneList=function(k){var l,i=this.tree,j=i.refMap[this.refKey]||null,m=i.keyMap;if(j){l=this.key;if(k){j=f.map(j,function(n){return m[n]})}else{j=f.map(j,function(n){return n===l?null:m[n]});if(j.length<1){j=null}}}return j};f.ui.fancytree._FancytreeNodeClass.prototype.isClone=function(){var i=this.refKey||null,j=i&&this.tree.refMap[i]||null;return !!(j&&j.length>1)};f.ui.fancytree._FancytreeNodeClass.prototype.reRegister=function(n,i){n=(n==null)?null:""+n;i=(i==null)?null:""+i;this.debug("reRegister",n,i);var q=this.tree,p=this.key,l=this.refKey,j=q.keyMap,k=q.refMap,o=k[l]||null,m=false;if(n!=null&&n!==this.key){if(j[n]){f.error("[ext-clones] reRegister("+n+"): already exists.")}delete j[p];j[n]=this;if(o){k[l]=f.map(o,function(r){return r===p?n:r})}this.key=n;m=true}if(i!=null&&i!==this.refKey){if(o){if(o.length===1){delete k[l]}else{k[l]=f.map(o,function(r){return r===p?null:r})}}if(k[i]){k[i].append(n)}else{k[i]=[this.key]}this.refKey=i;m=true}return m};f.ui.fancytree._FancytreeClass.prototype.getNodesByRef=function(i,j){var l=this.keyMap,k=this.refMap[i]||null;if(k){if(j){k=f.map(k,function(n){var m=l[n];return m.isDescendantOf(j)?m:null})}else{k=f.map(k,function(m){return l[m]})}if(k.length<1){k=null}}return k};f.ui.fancytree._FancytreeClass.prototype.changeRefKey=function(j,k){var m,n,o=this.keyMap,l=this.refMap[j]||null;if(l){for(m=0;m<l.length;m++){n=o[l[m]];n.refKey=k}delete this.refMap[j];this.refMap[k]=l}};f.ui.fancytree.registerExtension({name:"clones",version:"0.0.3",options:{highlightActiveClones:true,highlightClones:false},treeCreate:function(i){this._super(i);i.tree.refMap={};i.tree.keyMap={}},treeInit:function(i){this.$container.addClass("fancytree-ext-clones");d(i.options.defaultKey==null);i.options.defaultKey=function(j){return a(j)};this._super(i)},treeClear:function(i){i.tree.refMap={};i.tree.keyMap={};return this._super(i)},treeRegisterNode:function(q,p,i){var o,k,r=q.tree,l=r.keyMap,m=r.refMap,n=i.key,j=(i&&i.refKey!=null)?""+i.refKey:null;if(n==="_statusNode"){return this._super(q,p,i)}if(p){if(l[i.key]!=null){f.error("clones.treeRegisterNode: node.key already exists: "+i.key)}l[n]=i;if(j){o=m[j];if(o){o.push(n);if(o.length===2&&q.options.clones.highlightClones){l[o[0]].renderStatus()}}else{m[j]=[n]}i.debug("clones.treeRegisterNode: add clone =>",m[j])}}else{if(l[n]==null){f.error("clones.treeRegisterNode: node.key not registered: "+i.key)}delete l[n];if(j){o=m[j];i.debug("clones.treeRegisterNode: remove clone BEFORE =>",m[j]);if(o){k=o.length;if(k<=1){d(k===1);d(o[0]===n);delete m[j]}else{h(o,n);if(k===2&&q.options.clones.highlightClones){l[o[0]].renderStatus()}}i.debug("clones.treeRegisterNode: remove clone =>",m[j])}}}return this._super(q,p,i)},nodeRenderStatus:function(j){var i,k,l=j.node;k=this._super(j);if(j.options.clones.highlightClones){i=f(l[j.tree.statusClassPropName]);if(i.length&&l.isClone()){i.addClass("fancytree-clone")}}return k},nodeSetActive:function(j,i){var k,m=j.tree.statusClassPropName,l=j.node;k=this._super(j,i);if(j.options.clones.highlightActiveClones&&l.isClone()){f.each(l.getCloneList(true),function(o,p){p.debug("clones.nodeSetActive: ",i!==false);f(p[m]).toggleClass("fancytree-active-clone",i!==false)})}return k}})}(jQuery,window,document));
/*!
 ...
 * @date 2014-08-17T10:39
 */
;(function(f,e,b,g){var d=/Mac/.test(navigator.platform),a=f.ui.fancytree.escapeHtml,c=f.ui.fancytree.unescapeHtml;f.ui.fancytree._FancytreeNodeClass.prototype.editStart=function(){var o,m=this,i=this.tree,j=i.ext.edit,n=m.title,h=i.options.edit,l=f(".fancytree-title",m.span),k={node:m,tree:i,options:i.options};if(h.beforeEdit.call(m,{type:"beforeEdit"},k)===false){return false}n=m.title;m.debug("editStart");i.widget._unbind();f(b).on("mousedown.fancytree-edit",function(p){if(!f(p.target).hasClass("fancytree-edit-input")){m.editEnd(true,p)}});o=f("<input />",{"class":"fancytree-edit-input",value:c(n)});if(h.adjustWidthOfs!=null){o.width(l.width()+h.adjustWidthOfs)}if(h.inputCss!=null){o.css(h.inputCss)}k.input=o;l.html(o);f.ui.fancytree.assert(!j.currentNode,"recursive edit");j.currentNode=this;o.focus().change(function(p){o.addClass("fancytree-edit-dirty")}).keydown(function(p){switch(p.which){case f.ui.keyCode.ESCAPE:m.editEnd(false,p);break;case f.ui.keyCode.ENTER:m.editEnd(true,p);return false}p.stopPropagation()}).blur(function(p){return m.editEnd(true,p)});h.edit.call(m,{type:"edit"},k)};f.ui.fancytree._FancytreeNodeClass.prototype.editEnd=function(r,l){var k=this,s=this.tree,p=s.ext.edit,m=s.options.edit,o=f(".fancytree-title",k.span),n=o.find("input.fancytree-edit-input"),j=n.val(),i=n.hasClass("fancytree-edit-dirty"),h=(r||(i&&r!==false))&&(j!==k.title),q={node:k,tree:s,options:s.options,originalEvent:l,dirty:i,save:h,input:n,value:j};if(m.beforeClose.call(k,{type:"beforeClose"},q)===false){return false}if(h&&m.save.call(k,{type:"save"},q)===false){return false}n.removeClass("fancytree-edit-dirty").unbind();f(b).off(".fancytree-edit");if(h){k.setTitle(a(j))}else{k.renderTitle()}s.widget._bind();p.currentNode=null;k.setFocus();f(s.$container).focus();q.input=null;m.close.call(k,{type:"close"},q);return true};f.ui.fancytree._FancytreeNodeClass.prototype.startEdit=function(){this.warn("FancytreeNode.startEdit() is deprecated since 2014-01-04. Use .editStart() instead.");return this.editStart.apply(this,arguments)};f.ui.fancytree._FancytreeNodeClass.prototype.endEdit=function(){this.warn("FancytreeNode.endEdit() is deprecated since 2014-01-04. Use .editEnd() instead.");return this.editEnd.apply(this,arguments)};f.ui.fancytree._FancytreeClass.prototype.isEditing=function(){return this.ext.edit.currentNode};f.ui.fancytree._FancytreeNodeClass.prototype.isEditing=function(){return this.tree.ext.edit.currentNode===this};f.ui.fancytree.registerExtension({name:"edit",version:"0.1.0",options:{adjustWidthOfs:4,inputCss:{minWidth:"3em"},triggerCancel:["esc","tab","click"],triggerStart:["f2","shift+click","mac+enter"],beforeClose:f.noop,beforeEdit:f.noop,close:f.noop,edit:f.noop,save:f.noop},currentNode:null,treeInit:function(h){this._super(h);this.$container.addClass("fancytree-ext-edit")},nodeClick:function(h){if(f.inArray("shift+click",h.options.edit.triggerStart)>=0){if(h.originalEvent.shiftKey){h.node.editStart();return false}}return this._super(h)},nodeDblclick:function(h){if(f.inArray("dblclick",h.options.edit.triggerStart)>=0){h.node.editStart();return false}return this._super(h)},nodeKeydown:function(h){switch(h.originalEvent.which){case 113:if(f.inArray("f2",h.options.edit.triggerStart)>=0){h.node.editStart();return false}break;case f.ui.keyCode.ENTER:if(f.inArray("mac+enter",h.options.edit.triggerStart)>=0&&d){h.node.editStart();return false}break}return this._super(h)}})}(jQuery,window,document));
/*!
 ...
 * @date 2014-08-17T10:39
 */
;(function(c,f,i,b){function e(k,l){l=l||"";if(!k){c.error("Assertion failed "+l)}}var j="active",g="expanded",h="focus",d="selected";function a(w,t,p,r,v){var q,u,n,m,s=false,o=[],k=[];p=p||[];v=v||c.Deferred();for(q=0,n=p.length;q<n;q++){u=p[q];m=w.getNodeByKey(u);if(m){if(r&&m.isUndefined()){s=true;w.debug("_loadLazyNodes: "+m+" is lazy: loading...");if(r==="expand"){o.push(m.setExpanded())}else{o.push(m.load())}}else{w.debug("_loadLazyNodes: "+m+" already loaded.");m.setExpanded()}}else{k.push(u);w.debug("_loadLazyNodes: "+m+" was not yet found.")}}c.when.apply(c,o).always(function(){if(s&&k.length>0){a(w,t,k,r,v)}else{if(k.length){w.warn("_loadLazyNodes: could not load those keys: ",k);for(q=0,n=k.length;q<n;q++){u=p[q];t._appendKey(g,p[q],false)}}v.resolve()}});return v}c.ui.fancytree._FancytreeClass.prototype.clearCookies=function(l){var k=this.ext.persist,m=k.cookiePrefix;l=l||"active expanded focus selected";if(l.indexOf(j)>=0){k._data(m+j,null)}if(l.indexOf(g)>=0){k._data(m+g,null)}if(l.indexOf(h)>=0){k._data(m+h,null)}if(l.indexOf(d)>=0){k._data(m+d,null)}};c.ui.fancytree._FancytreeClass.prototype.getPersistData=function(){var l=this.ext.persist,m=l.cookiePrefix,n=l.cookieDelimiter,k={};k[j]=l._data(m+j);k[g]=(l._data(m+g)||"").split(n);k[d]=(l._data(m+d)||"").split(n);k[h]=l._data(m+h);return k};c.ui.fancytree.registerExtension({name:"persist",version:"0.3.0",options:{cookieDelimiter:"~",cookiePrefix:b,cookie:{raw:false,expires:"",path:"",domain:"",secure:false},expandLazy:false,overrideSource:false,store:"auto",types:"active expanded focus selected"},_data:function(l,m){var k=this._local.localStorage;if(m===b){return k?k.getItem(l):c.cookie(l)}else{if(m===null){if(k){k.removeItem(l)}else{c.removeCookie(l)}}else{if(k){k.setItem(l,m)}else{c.cookie(l,m,this.options.persist.cookie)}}}},_appendKey:function(p,t,o){t=""+t;var r=this._local,n=this.options.persist,k=n.cookieDelimiter,q=r.cookiePrefix+p,m=r._data(q),l=m?m.split(k):[],s=c.inArray(t,l);if(s>=0){l.splice(s,1)}if(o){l.push(t)}r._data(q,l.join(k))},treeInit:function(m){var l=m.tree,o=m.options,n=this._local,k=this.options.persist;e(k.store==="localStore"||c.cookie,"Missing required plugin for 'persist' extension: jquery.cookie.js");n.cookiePrefix=k.cookiePrefix||("fancytree-"+l._id+"-");n.storeActive=k.types.indexOf(j)>=0;n.storeExpanded=k.types.indexOf(g)>=0;n.storeSelected=k.types.indexOf(d)>=0;n.storeFocus=k.types.indexOf(h)>=0;if(k.store==="cookie"||!f.localStorage){n.localStorage=null}else{n.localStorage=(k.store==="local")?f.localStorage:f.sessionStorage}l.$div.bind("fancytreeinit",function(u){var s,p,r,v,t,q=c.cookie(n.cookiePrefix+h);l.debug("COOKIE "+i.cookie);s=n._data(n.cookiePrefix+g);v=s&&s.split(k.cookieDelimiter);if(n.storeExpanded){p=a(l,n,v,k.expandLazy?"expand":false,null)}else{p=new c.Deferred().resolve()}p.done(function(){if(n.storeSelected){s=n._data(n.cookiePrefix+d);if(s){v=s.split(k.cookieDelimiter);for(r=0;r<v.length;r++){t=l.getNodeByKey(v[r]);if(t){if(t.selected===b||k.overrideSource&&(t.selected===false)){t.selected=true;t.renderStatus()}}else{n._appendKey(d,v[r],false)}}}}if(n.storeActive){s=n._data(n.cookiePrefix+j);if(s&&(o.persist.overrideSource||!l.activeNode)){t=l.getNodeByKey(s);if(t){t.setActive()}}}if(n.storeFocus&&q){t=l.getNodeByKey(q);if(t){t.setFocus()}}})});return this._super(m)},nodeSetActive:function(l,k,o){var n,m=this._local;k=(k!==false);n=this._super(l,k,o);if(m.storeActive){m._data(m.cookiePrefix+j,this.activeNode?this.activeNode.key:null)}return n},nodeSetExpanded:function(l,k,p){var n,o=l.node,m=this._local;k=(k!==false);n=this._super(l,k,p);if(m.storeExpanded){m._appendKey(g,o.key,k)}return n},nodeSetFocus:function(l,k){var n,m=this._local;k=(k!==false);n=this._super(l,k);if(k&&m.storeFocus){m._data(m.cookiePrefix+h,this.focusNode?this.focusNode.key:null)}return n},nodeSetSelected:function(l,k){var n,o=l.node,m=this._local;k=(k!==false);n=this._super(l,k);if(m.storeSelected){m._appendKey(d,o.key,k)}return n}})}(jQuery,window,document));
/*!
 ...
 * @date 2014-08-17T10:39
 */
;(function(g,e,a,h){function c(i,j){j=j||"";if(!i){g.error("Assertion failed "+j)}}function f(i,j){i.parentNode.insertBefore(j,i.nextSibling)}function b(j,i){j.visit(function(k){var l=k.tr;if(l){l.style.display=(k.hide||!i)?"none":""}if(!k.expanded){return"skip"}})}function d(n){var j,m,l,k=n.parent,o=k?k.children:null;if(o&&o.length>1&&o[0]!==n){j=g.inArray(n,o);l=o[j-1];c(l.tr);while(l.children){m=l.children[l.children.length-1];if(!m.tr){break}l=m}}else{l=k}return l}g.ui.fancytree.registerExtension({name:"table",version:"0.2.0",options:{checkboxColumnIdx:null,customStatus:false,indentation:16,nodeColumnIdx:0},treeInit:function(l){var n,k,o,j=l.tree,m=j.widget.element;m.addClass("fancytree-container fancytree-ext-table");j.tbody=m.find("> tbody")[0];j.columnCount=g("thead >tr >th",m).length;g(j.tbody).empty();j.rowFragment=a.createDocumentFragment();k=g("<tr />");o="";if(l.options.aria){k.attr("role","row");o=" role='gridcell'"}for(n=0;n<j.columnCount;n++){if(l.options.table.nodeColumnIdx===n){k.append("<td"+o+"><span class='fancytree-node' /></td>")}else{k.append("<td"+o+" />")}}j.rowFragment.appendChild(k.get(0));j.statusClassPropName="tr";j.ariaPropName="tr";this.nodeContainerAttrName="tr";this._super(l);g(j.rootNode.ul).remove();j.rootNode.ul=null;j.$container=m;this.$container.attr("tabindex",this.options.tabbable?"0":"-1");if(this.options.aria){j.$container.attr("role","treegrid").attr("aria-readonly",true)}},nodeRemoveChildMarkup:function(i){var j=i.node;j.visit(function(k){if(k.tr){g(k.tr).remove();k.tr=null}})},nodeRemoveMarkup:function(i){var j=i.node;if(j.tr){g(j.tr).remove();j.tr=null}this.nodeRemoveChildMarkup(i)},nodeRender:function(z,m,w,r,o){var n,v,s,q,y,k,u,t,A=z.tree,p=z.node,j=z.options,x=!p.parent;if(!o){z.hasCollapsedParents=p.parent&&!p.parent.expanded}if(!x){if(!p.tr){if(z.hasCollapsedParents){p.debug("nodeRender ignored due to unrendered parent");return}y=A.rowFragment.firstChild.cloneNode(true);k=d(p);c(k);if(r===true&&o){y.style.display="none"}else{if(w&&z.hasCollapsedParents){y.style.display="none"}}if(!k.tr){c(!k.parent,"prev. row must have a tr, or is system root");A.tbody.appendChild(y)}else{f(k.tr,y)}p.tr=y;if(p.key&&j.generateIds){p.tr.id=j.idPrefix+p.key}p.tr.ftnode=p;if(j.aria){g(p.tr).attr("aria-labelledby","ftal_"+p.key)}p.span=g("span.fancytree-node",p.tr).get(0);this.nodeRenderTitle(z);if(j.createNode){j.createNode.call(A,{type:"createNode"},z)}}else{if(m){this.nodeRenderTitle(z)}else{this.nodeRenderStatus(z)}}}if(j.renderNode){j.renderNode.call(A,{type:"renderNode"},z)}n=p.children;if(n&&(x||w||p.expanded)){for(s=0,q=n.length;s<q;s++){t=g.extend({},z,{node:n[s]});t.hasCollapsedParents=t.hasCollapsedParents||!p.expanded;this.nodeRender(t,m,w,r,true)}}if(n&&!o){u=p.tr||null;v=A.tbody.firstChild;p.visit(function(l){if(l.tr){if(!l.parent.expanded&&l.tr.style.display!=="none"){l.tr.style.display="none";b(l,false)}if(l.tr.previousSibling!==u){p.debug("_fixOrder: mismatch at node: "+l);var i=u?u.nextSibling:v;A.tbody.insertBefore(l.tr,i)}u=l.tr}})}},nodeRenderTitle:function(i,l){var m,k=i.node,j=i.options;this._super(i);if(j.checkbox&&j.table.checkboxColumnIdx!=null){m=g("span.fancytree-checkbox",k.span).detach();g(k.tr).find("td:first").html(m)}if(!k.isRoot()){this.nodeRenderStatus(i)}if(!j.table.customStatus&&k.isStatusNode()){}else{if(j.renderColumns){j.renderColumns.call(i.tree,{type:"renderColumns"},i)}}},nodeRenderStatus:function(j){var i,l=j.node,k=j.options;this._super(j);g(l.tr).removeClass("fancytree-node");i=(l.getLevel()-1)*k.table.indentation;g(l.span).css({marginLeft:i+"px"})},nodeSetExpanded:function(k,j,m){var i=new g.Deferred(),n=g.extend({},m,{noEvents:true,noAnimation:true});m=m||{};function l(o){j=(j!==false);b(k.node,j);if(o){if(j&&k.options.autoScroll&&!m.noAnimation&&k.node.hasChildren()){k.node.getLastChild().scrollIntoView(true,{topNode:k.node}).always(function(){if(!m.noEvents){k.tree._triggerNodeEvent(j?"expand":"collapse",k)}i.resolveWith(k.node)})}else{if(!m.noEvents){k.tree._triggerNodeEvent(j?"expand":"collapse",k)}i.resolveWith(k.node)}}else{if(!m.noEvents){k.tree._triggerNodeEvent(j?"expand":"collapse",k)}i.rejectWith(k.node)}}this._super(k,j,n).done(function(){l(true)}).fail(function(){l(false)});return i.promise()},nodeSetStatus:function(j,i,m,k){if(i==="ok"){var l=j.node,n=(l.children?l.children[0]:null);if(n&&n.isStatusNode()){g(n.tr).remove()}}this._super(j,i,m,k)},treeClear:function(i){this.nodeRemoveChildMarkup(this._makeHookContext(this.rootNode));return this._super(i)}})}(jQuery,window,document));
/*!
 ...
 * @date 2014-08-17T10:39
 */
;(function(c,b,a,d){c.ui.fancytree.registerExtension({name:"themeroller",version:"0.0.1",options:{activeClass:"ui-state-active",foccusClass:"ui-state-focus",hoverClass:"ui-state-hover",selectedClass:"ui-state-highlight"},treeInit:function(e){this._super(e);var f=e.widget.element;if(f[0].nodeName==="TABLE"){f.addClass("ui-widget ui-corner-all");f.find(">thead tr").addClass("ui-widget-header");f.find(">tbody").addClass("ui-widget-conent")}else{f.addClass("ui-widget ui-widget-content ui-corner-all")}f.delegate(".fancytree-node","mouseenter mouseleave",function(i){var h=c.ui.fancytree.getNode(i.target),g=(i.type==="mouseenter");h.debug("hover: "+g);c(h.span).toggleClass("ui-state-hover ui-corner-all",g)})},treeDestroy:function(e){this._super(e);e.widget.element.removeClass("ui-widget ui-widget-content ui-corner-all")},nodeRenderStatus:function(e){var g=e.node,f=c(g.span);this._super(e);f.toggleClass("ui-state-active",g.isActive());f.toggleClass("ui-state-focus",g.hasFocus());f.toggleClass("ui-state-highlight",g.isSelected())}})}(jQuery,window,document));
/*!
 * Fotorama 4.5.2 | http://fotorama.io/license/
 */
;fotoramaVersion="4.5.2",function(bY,bX,bW,bV,bU){function bT(e){var d="bez_"+bV.makeArray(arguments).join("_").replace(".","p");if("function"!=typeof bV.easing[d]){var f=function(j,i){var p=[null,null],o=[null,null],n=[null,null],m=function(b,a){return n[a]=3*j[a],o[a]=3*(i[a]-j[a])-n[a],p[a]=1-n[a]-o[a],b*(n[a]+b*(o[a]+b*p[a]))},l=function(b){return n[0]+b*(2*o[0]+3*p[0]*b)},k=function(h){for(var g,r=h,q=0;++q<14&&(g=m(r,0)-h,!(Math.abs(g)<0.001));){r-=g/l(r)}return r};return function(b){return m(k(b),1)}};bV.easing[d]=function(a,j,i,h,c){return h*f([e[0],e[1]],[e[2],e[3]])(j/c)+i}}return d}function bR(){}function bP(e,d,f){return Math.max(isNaN(d)?-1/0:d,Math.min(isNaN(f)?1/0:f,e))}function bO(b){return b.match(/ma/)&&b.match(/-?\d+(?!d)/g)[b.match(/3d/)?12:4]}function bM(b){return bq?+bO(b.css("transform")):+b.css("left").replace("px","")}function bL(d){var c={};return bq?c.transform="translate3d("+d+"px,0,0)":c.left=d,c}function bK(b){return{"transition-duration":b+"ms"}}function bJ(d,c){return +String(d).replace(c||"px","")||bU}function bI(b){return/%$/.test(b)&&bJ(b,"%")}function bH(d,c){return bI(d)/100*c||bJ(d)}function bG(b){return(!!bJ(b)||!!bJ(b,"%"))&&b}function bF(f,e,h,g){return(f-(g||0))*(e+(h||0))}function bD(f,e,h,g){return -Math.round(f/(e+(h||0))-(g||0))}function bC(f){var e=f.data();if(!e.tEnd){var h=f[0],g={WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd otransitionend",msTransition:"MSTransitionEnd",transition:"transitionend"};cf(h,g[aX.prefixed("transition")],function(b){e.tProp&&b.propertyName.match(e.tProp)&&e.onEndFn()}),e.tEnd=!0}}function bA(h,g,l,k){var j,i=h.data();i&&(i.onEndFn=function(){j||(j=!0,clearTimeout(i.tT),l())},i.tProp=g,clearTimeout(i.tT),i.tT=setTimeout(function(){i.onEndFn()},1.5*k),bC(h))}function bz(f,e){if(f.length){var h=f.data();bq?(f.css(bK(0)),h.onEndFn=bR,clearTimeout(h.tT)):f.stop();var g=by(e,function(){return bM(f)});return f.css(bL(g)),g}}function by(){for(var e,d=0,f=arguments.length;f>d&&(e=d?arguments[d]():arguments[d],"number"!=typeof e);d++){}return e}function bx(d,c){return Math.round(d+(c-d)/1.5)}function bw(){return bw.p=bw.p||("https:"===bW.protocol?"https://":"http://"),bw.p}function bv(b){var d=bX.createElement("a");return d.href=b,d}function bu(g,f){if("string"!=typeof g){return g}g=bv(g);var j,i;if(g.host.match(/youtube\.com/)&&g.search){if(j=g.search.split("v=")[1]){var h=j.indexOf("&");-1!==h&&(j=j.substring(0,h)),i="youtube"}}else{g.host.match(/youtube\.com|youtu\.be/)?(j=g.pathname.replace(/^\/(embed\/|v\/)?/,"").replace(/\/.*/,""),i="youtube"):g.host.match(/vimeo\.com/)&&(i="vimeo",j=g.pathname.replace(/^\/(video\/)?/,"").replace(/\/.*/,""))}return j&&i||!f||(j=g.href,i="custom"),j?{id:j,type:i,s:g.search.replace(/^\?/,""),p:bw()}:!1}function cC(h,d,l){var k,j,i=h.video;return"youtube"===i.type?(j=bw()+"img.youtube.com/vi/"+i.id+"/default.jpg",k=j.replace(/\/default.jpg$/,"/hqdefault.jpg"),h.thumbsReady=!0):"vimeo"===i.type?bV.ajax({url:bw()+"vimeo.com/api/v2/video/"+i.id+".json",dataType:"jsonp",success:function(a){h.thumbsReady=!0,cB(d,{img:a[0].thumbnail_large,thumb:a[0].thumbnail_small},h.i,l)}}):h.thumbsReady=!0,{img:k,thumb:j}}function cB(j,d,p,o){for(var n=0,m=j.length;m>n;n++){var l=j[n];if(l.i===p&&l.thumbsReady){var k={videoReady:!0};k[aZ]=k[ai]=k[cA]=!1,o.splice(n,1,bV.extend({},l,k,d));break}}}function cz(f){function d(s,r,q){var p=s.children("img").eq(0),o=s.attr("href"),n=s.attr("src"),m=p.attr("src"),l=r.video,c=q?bu(o,l===!0):!1;c?o=!1:c=l,h(s,p,bV.extend(r,{video:c,img:r.img||o||n||m,thumb:r.thumb||m||n||o}))}function h(j,i,n){var m=n.thumb&&n.img!==n.thumb,l=bJ(n.width||j.attr("width")),k=bJ(n.height||j.attr("height"));bV.extend(n,{width:l,height:k,thumbratio:ch(n.thumbratio||bJ(n.thumbwidth||i&&i.attr("width")||m||l)/bJ(n.thumbheight||i&&i.attr("height")||m||k))})}var g=[];return f.children().each(function(){var b=bV(this),c=ci(bV.extend(b.data(),{id:b.attr("id")}));if(b.is("a, img")){d(b,c,!0)}else{if(b.is(":empty")){return}h(b,null,bV.extend(c,{html:this,_html:b.html()}))}g.push(c)}),g}function cy(b){return 0===b.offsetWidth&&0===b.offsetHeight}function cx(b){return !bV.contains(bX.documentElement,b)}function cw(e,d,f){e()?d():setTimeout(function(){cw(e,d)},f||100)}function cv(b){bW.replace(bW.protocol+"//"+bW.host+bW.pathname.replace(/^\/?/,"/")+bW.search+"#"+b)}function ct(x,w,v){var u=x.data(),t=u.measures;if(t&&(!u.l||u.l.W!==t.width||u.l.H!==t.height||u.l.r!==t.ratio||u.l.w!==w.w||u.l.h!==w.h||u.l.m!==v)){var s=t.width,r=t.height,q=w.w/w.h,p=t.ratio>=q,o="scaledown"===v,n="contain"===v,h="cover"===v;p&&(o||n)||!p&&h?(s=bP(w.w,0,o?s:1/0),r=s/t.ratio):(p&&h||!p&&(o||n))&&(r=bP(w.h,0,o?r:1/0),s=r*t.ratio),x.css({width:Math.ceil(s),height:Math.ceil(r),left:Math.floor(w.w/2-s/2),top:Math.floor(w.h/2-r/2)}),u.l={W:t.width,H:t.height,r:t.ratio,w:w.w,h:w.h,m:v}}return !0}function cr(e,d){var f=e[0];f.styleSheet?f.styleSheet.cssText=d:e.html(d)}function cq(e,d,f){return d===f?!1:d>=e?"left":e>=f?"right":"left right"}function co(j,i,p,o){if(!p){return !1}if(!isNaN(j)){return j-(o?0:1)}for(var n,m=0,l=i.length;l>m;m++){var k=i[m];if(k.id===j){n=m;break}}return n}function cn(e,d,f){f=f||{},e.each(function(){var b,g=bV(this),c=g.data();c.clickOn||(c.clickOn=!0,bV.extend(cO(g,{onStart:function(a){b=a,(f.onStart||bR).call(this,a)},onMove:f.onMove||bR,onTouchEnd:f.onTouchEnd||bR,onEnd:function(a){a.moved||d.call(this,b)}}),{noMove:!0}))})}function cm(d,c){return'<div class="'+d+'">'+(c||"")+"</div>"}function cl(f){for(var e=f.length;e;){var h=Math.floor(Math.random()*e--),g=f[e];f[e]=f[h],f[h]=g}return f}function ck(b){return"[object Array]"==Object.prototype.toString.call(b)&&bV.map(b,function(c){return bV.extend({},c)})}function cj(e,d,f){e.scrollLeft(d||0).scrollTop(f||0)}function ci(d){if(d){var c={};return bV.each(d,function(b,e){c[b.toLowerCase()]=e}),c}}function ch(d){if(d){var c=+d;return isNaN(c)?(c=d.split("/"),+c[0]/+c[1]||bU):c}}function cf(f,e,h,g){e&&(f.addEventListener?f.addEventListener(e,h,!!g):f.attachEvent("on"+e,h))}function ce(b){return !!b.getAttribute("disabled")}function b9(b){return{tabindex:-1*b+"",disabled:b}}function b8(d,c){cf(d,"keyup",function(a){ce(d)||13==a.keyCode&&c.call(d,a)})}function b7(d,c){cf(d,"focus",d.onfocusin=function(a){c.call(d,a)},!0)}function b6(d,c){d.preventDefault?d.preventDefault():d.returnValue=!1,c&&d.stopPropagation()}function b5(b){return b?">":"<"}function b4(g,d){var l=g.data(),k=Math.round(d.pos),j=function(){l.sliding=!1,(d.onEnd||bR)()};"undefined"!=typeof d.overPos&&d.overPos!==d.pos&&(k=d.overPos,j=function(){b4(g,bV.extend({},d,{overPos:d.pos,time:Math.max(ae,d.time/2)}))});var i=bV.extend(bL(k),d.width&&{width:d.width});l.sliding=!0,bq?(g.css(bV.extend(bK(d.time),i)),d.time>10?bA(g,"transform",j,d.time):j()):g.stop().animate(i,d.time,cp,j)}function cP(x,w,v,u,t,s){var r="undefined"!=typeof s;if(r||(t.push(arguments),Array.prototype.push.call(arguments,t.length),!(t.length>1))){x=x||bV(x),w=w||bV(w);var q=x[0],p=w[0],o="crossfade"===u.method,g=function(){if(!g.done){g.done=!0;var b=(r||t.shift())&&t.shift();b&&cP.apply(this,b),(u.onEnd||bR)(!!b)}},d=u.time/(s||1);v.removeClass(aG+" "+aO),x.stop().addClass(aG),w.stop().addClass(aO),o&&p&&x.fadeTo(0,0),x.fadeTo(o?d:0,1,o&&g),w.fadeTo(d,0,g),q&&o||p||g()}}function b0(d){var c=(d.touches||[])[0]||d;d._x=c.pageX,d._y=c.clientY,d._now=bV.now()}function cO(J,I){function H(c){return A=bV(c.target),a.checked=x=w=d=!1,C||a.flow||c.touches&&c.touches.length>1||c.which>1||aJ&&aJ.type!==c.type&&at||(x=I.select&&A.is(I.select,b))?x:(y="touchstart"===c.type,w=A.is("a, a *",b),z=a.control,g=a.noMove||a.noSwipe||z?16:a.snap?0:4,b0(c),B=aJ=c,aB=c.type.replace(/down|start/,"move").replace(/Down/,"Move"),(I.onStart||bR).call(b,c,{control:z,$target:A}),C=a.flow=!0,void ((!y||a.go)&&b6(c)))}function G(i){if(i.touches&&i.touches.length>1||aF&&!i.isPrimary||aB!==i.type||!C){return C&&F(),void (I.onTouchEnd||bR)()}b0(i);var e=Math.abs(i._x-B._x),m=Math.abs(i._y-B._y),l=e-m,k=(a.go||a.x||l>=0)&&!a.noSwipe,j=0>l;y&&!a.checked?(C=k)&&b6(i):(b6(i),(I.onMove||bR).call(b,i,{touch:y})),!d&&Math.sqrt(Math.pow(e,2)+Math.pow(m,2))>g&&(d=!0),a.checked=a.checked||k||j}function F(e){(I.onTouchEnd||bR)();var c=C;a.control=C=!1,c&&(a.flow=!1),!c||w&&!a.checked||(e&&b6(e),at=!0,clearTimeout(ak),ak=setTimeout(function(){at=!1},1000),(I.onEnd||bR).call(b,{moved:d,$target:A,control:z,touch:y,startEvent:B,aborted:!e||"MSPointerCancel"===e.type}))}function E(){a.flow||setTimeout(function(){a.flow=!0},10)}function D(){a.flow&&setTimeout(function(){a.flow=!1},ao)}var C,B,A,z,y,x,w,g,d,b=J[0],a={};return aF?(cf(b,"MSPointerDown",H),cf(bX,"MSPointerMove",G),cf(bX,"MSPointerCancel",F),cf(bX,"MSPointerUp",F)):(cf(b,"touchstart",H),cf(b,"touchmove",G),cf(b,"touchend",F),cf(bX,"touchstart",E),cf(bX,"touchend",D),cf(bX,"touchcancel",D),cf(bY,"scroll",D),cf(b,"mousedown",H),cf(bX,"mousemove",G),cf(bX,"mouseup",F)),J.on("click","a",function(c){a.checked&&b6(c)}),a}function cu(V,U){function T(b,a){J=!0,P=O=b._x,I=b._now,K=[[I,P]],N=M=w.noMove||a?0:bz(V,(U.getPos||bR)()),(U.onStart||bR).call(H,b)}function S(e,c){E=w.min,u=w.max,k=w.snap,h=e.altKey,J=d=!1,g=c.control,g||F.sliding||T(e)}function R(b,a){w.noSwipe||(J||T(b),O=b._x,K.push([b._now,O]),M=N-(P-O),L=cq(M,E,u),E>=M?M=bx(M,E):M>=u&&(M=bx(M,u)),w.noMove||(V.css(bL(M)),d||(d=!0,a.touch||aF||V.addClass(bQ)),(U.onMove||bR).call(H,b,{pos:M,edge:L})))}function Q(ab){if(!w.noSwipe||!ab.moved){J||T(ab.startEvent,!0),ab.touch||aF||V.removeClass(bQ),G=bV.now();for(var Z,Y,X,W,D,B,v,r,m,c=G-ao,A=null,x=ae,t=U.friction,s=K.length-1;s>=0;s--){if(Z=K[s][0],Y=Math.abs(Z-c),null===A||X>Y){A=Z,W=K[s][1]}else{if(A===c||Y>X){break}}X=Y}v=bP(M,E,u);var p=W-O,n=p>=0,l=G-A,b=l>ao,a=!b&&M!==N&&v===M;k&&(v=bP(Math[a?n?"floor":"ceil":"round"](M/k)*k,E,u),E=u=v),a&&(k||v===M)&&(m=-(p/l),x*=bP(Math.abs(m),U.timeLow,U.timeHigh),D=Math.round(M+m*x/t),k||(v=D),(!n&&D>u||n&&E>D)&&(B=n?E:u,r=D-B,k||(v=B),r=bP(v+0.03*r,B-50,B+50),x=Math.abs((M-r)/(m/t)))),x*=h?10:1,(U.onEnd||bR).call(H,bV.extend(ab,{moved:ab.moved||b&&k,pos:M,newPos:v,overPos:r,time:x}))}}var P,O,N,M,L,K,I,G,E,u,k,h,g,d,J,H=V[0],F=V.data(),w={};return w=bV.extend(cO(U.$wrap,bV.extend({},U,{onStart:S,onMove:R,onEnd:Q})),w)}function bS(g,d){var n,m,l,k=g[0],j={prevent:{}};return cf(k,ax,function(e){var p=e.wheelDeltaY||-1*e.deltaY||0,i=e.wheelDeltaX||-1*e.deltaX||0,f=Math.abs(i)&&!Math.abs(p),c=b5(0>i),b=m===c,r=bV.now(),q=ao>r-l;m=c,l=r,f&&j.ok&&(!j.prevent[c]||n)&&(b6(e,!0),n&&b&&q||(d.shift&&(n=!0,clearTimeout(j.t),j.t=setTimeout(function(){n=!1},cU)),(d.onEnd||bR)(e,d.shift?c:i)))}),j}function bp(){bV.each(bV.Fotorama.instances,function(d,c){c.index=d})}function bg(b){bV.Fotorama.instances.push(b),bp()}function a4(b){bV.Fotorama.instances.splice(b.index,1),bp()}var aU="fotorama",aM="fullscreen",aE=aU+"__wrap",aw=aE+"--css2",an=aE+"--css3",aa=aE+"--video",cT=aE+"--fade",cH=aE+"--slide",b3=aE+"--no-controls",bt=aE+"--no-shadows",bk=aE+"--pan-y",a8=aE+"--rtl",aY=aE+"--only-active",aQ=aE+"--no-captions",aI=aE+"--toggle-arrows",aA=aU+"__stage",ar=aA+"__frame",ah=ar+"--video",cX=aA+"__shaft",cL=aU+"__grab",a2=aU+"__pointer",aS=aU+"__arr",aK=aS+"--disabled",aC=aS+"--prev",au=aS+"--next",al=aU+"__nav",cZ=al+"-wrap",cR=al+"__shaft",cF=al+"--dots",b1=al+"--thumbs",br=al+"__frame",bi=br+"--dot",a6=br+"--thumb",aW=aU+"__fade",aO=aW+"-front",aG=aW+"-rear",ay=aU+"__shadow",ap=ay+"s",af=ap+"--left",cV=ap+"--right",cJ=aU+"__active",cg=aU+"__select",bE=aU+"--hidden",bm=aU+"--fullscreen",ba=aU+"__fullscreen-icon",a0=aU+"__error",cD=aU+"__loading",aj=aU+"__loaded",cN=aj+"--full",cs=aj+"--img",bQ=aU+"__grabbing",bo=aU+"__img",bf=bo+"--full",a3=aU+"__dot",aT=aU+"__thumb",aL=aT+"-border",aD=aU+"__html",av=aU+"__video",am=av+"-play",c0=av+"-close",cS=aU+"__caption",cG=aU+"__caption__wrap",b2=aU+"__spinner",bs='" tabindex="0" role="button',bj=bV&&bV.fn.jquery.split(".");if(!bj||bj[0]<1||1==bj[0]&&bj[1]<8){throw"Fotorama requires jQuery 1.8 or later and will not run without it."}var a7={},aX=function(bb,ad,ac){function ab(b){K.cssText=b}function Z(d,c){return typeof d===c}function Y(d,c){return !!~(""+d).indexOf(c)}function X(f,c){for(var h in f){var g=f[h];if(!Y(g,"-")&&K[g]!==ac){return"pfx"==c?g:!0}}return !1}function W(e,c,j){for(var i in e){var h=c[e[i]];if(h!==ac){return j===!1?e[i]:Z(h,"function")?h.bind(j||c):h}}return !1}function V(g,e,j){var i=g.charAt(0).toUpperCase()+g.slice(1),h=(g+" "+H.join(i+" ")+i).split(" ");return Z(e,"string")||Z(e,"undefined")?X(h,e):(h=(g+" "+G.join(i+" ")+i).split(" "),W(h,e,j))}var U,T,S,R="2.6.2",Q={},P=ad.documentElement,O="modernizr",M=ad.createElement(O),K=M.style,J=({}.toString," -webkit- -moz- -o- -ms- ".split(" ")),I="Webkit Moz O ms",H=I.split(" "),G=I.toLowerCase().split(" "),F={},E=[],D=E.slice,C=function(v,u,t,s){var r,q,p,o,n=ad.createElement("div"),m=ad.body,b=m||ad.createElement("body");if(parseInt(t,10)){for(;t--;){p=ad.createElement("div"),p.id=s?s[t]:O+(t+1),n.appendChild(p)}}return r=["&#173;",'<style id="s',O,'">',v,"</style>"].join(""),n.id=O,(m?n:b).innerHTML+=r,b.appendChild(n),m||(b.style.background="",b.style.overflow="hidden",o=P.style.overflow,P.style.overflow="hidden",P.appendChild(b)),q=u(n,v),m?n.parentNode.removeChild(n):(b.parentNode.removeChild(b),P.style.overflow=o),!!q},N={}.hasOwnProperty;S=Z(N,"undefined")||Z(N.call,"undefined")?function(d,c){return c in d&&Z(d.constructor.prototype[c],"undefined")}:function(d,c){return N.call(d,c)},Function.prototype.bind||(Function.prototype.bind=function(f){var e=this;if("function"!=typeof e){throw new TypeError}var h=D.call(arguments,1),g=function(){if(this instanceof g){var c=function(){};c.prototype=e.prototype;var b=new c,a=e.apply(b,h.concat(D.call(arguments)));return Object(a)===a?a:b}return e.apply(f,h.concat(D.call(arguments)))};return g}),F.csstransforms3d=function(){var b=!!V("perspective");return b};for(var L in F){S(F,L)&&(T=L.toLowerCase(),Q[T]=F[L](),E.push((Q[T]?"":"no-")+T))}return Q.addTest=function(e,c){if("object"==typeof e){for(var f in e){S(e,f)&&Q.addTest(f,e[f])}}else{if(e=e.toLowerCase(),Q[e]!==ac){return Q}c="function"==typeof c?c():c,"undefined"!=typeof enableClasses&&enableClasses&&(P.className+=" "+(c?"":"no-")+e),Q[e]=c}return Q},ab(""),M=U=null,Q._version=R,Q._prefixes=J,Q._domPrefixes=G,Q._cssomPrefixes=H,Q.testProp=function(b){return X([b])},Q.testAllProps=V,Q.testStyles=C,Q.prefixed=function(e,d,f){return d?V(e,d,f):V(e,"pfx")},Q}(bY,bX),aP={ok:!1,is:function(){return !1},request:function(){},cancel:function(){},event:"",prefix:""},aH="webkit moz o ms khtml".split(" ");if("undefined"!=typeof bX.cancelFullScreen){aP.ok=!0}else{for(var az=0,aq=aH.length;aq>az;az++){if(aP.prefix=aH[az],"undefined"!=typeof bX[aP.prefix+"CancelFullScreen"]){aP.ok=!0;break}}}aP.ok&&(aP.event=aP.prefix+"fullscreenchange",aP.is=function(){switch(this.prefix){case"":return bX.fullScreen;case"webkit":return bX.webkitIsFullScreen;default:return bX[this.prefix+"FullScreen"]}},aP.request=function(b){return""===this.prefix?b.requestFullScreen():b[this.prefix+"RequestFullScreen"]()},aP.cancel=function(){return""===this.prefix?bX.cancelFullScreen():bX[this.prefix+"CancelFullScreen"]()});var ag,cW={lines:12,length:5,width:2,radius:7,corners:1,rotate:15,color:"rgba(128, 128, 128, .75)",hwaccel:!0},cK={top:"auto",left:"auto",className:""};!function(d,c){ag=c()}(this,function(){function F(f,i){var h,g=bX.createElement(f||"div");for(h in i){g[h]=i[h]}return g}function E(f){for(var d=1,g=arguments.length;g>d;d++){f.appendChild(arguments[d])}return f}function D(r,q,p,o){var n=["opacity",q,~~(100*r),p,o].join("-"),m=0.01+p/o*100,l=Math.max(1-(1-r)/q*(100-m),r),k=v.substring(0,v.indexOf("Animation")).toLowerCase(),j=k&&"-"+k+"-"||"";return t[n]||(s.insertRule("@"+j+"keyframes "+n+"{0%{opacity:"+l+"}"+m+"%{opacity:"+r+"}"+(m+0.01)+"%{opacity:1}"+(m+q)%100+"%{opacity:"+r+"}100%{opacity:"+l+"}}",s.cssRules.length),t[n]=1),n}function C(h,g){var k,j,i=h.style;for(g=g.charAt(0).toUpperCase()+g.slice(1),j=0;j<u.length;j++){if(k=u[j]+g,i[k]!==bU){return k}}return i[g]!==bU?g:void 0}function B(f,d){for(var g in d){f.style[C(f,g)||g]=d[g]}return f}function A(g){for(var f=1;f<arguments.length;f++){var i=arguments[f];for(var h in i){g[h]===bU&&(g[h]=i[h])}}return g}function z(d){for(var c={x:d.offsetLeft,y:d.offsetTop};d=d.offsetParent;){c.x+=d.offsetLeft,c.y+=d.offsetTop}return c}function y(d,c){return"string"==typeof d?d:d[c%d.length]}function x(c){return"undefined"==typeof this?new x(c):void (this.opts=A(c||{},x.defaults,e))}function w(){function a(d,f){return F("<"+d+' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">',f)}s.addRule(".spin-vml","behavior:url(#default#VML)"),x.prototype.lines=function(G,r){function q(){return B(a("group",{coordsize:j+" "+j,coordorigin:-n+" "+-n}),{width:j,height:j})}function p(d,k,i){E(c,E(B(q(),{rotation:360/r.lines*d+"deg",left:~~k}),E(B(a("roundrect",{arcsize:r.corners}),{width:n,height:r.width,left:r.radius,top:-r.width>>1,filter:i}),a("fill",{color:y(r.color,d),opacity:r.opacity}),a("stroke",{opacity:0}))))}var o,n=r.length+r.width,j=2*n,g=2*-(r.width+r.length)+"px",c=B(q(),{position:"absolute",top:g,left:g});if(r.shadow){for(o=1;o<=r.lines;o++){p(o,-2,"progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)")}}for(o=1;o<=r.lines;o++){p(o)}return E(G,c)},x.prototype.opacity=function(g,f,j,i){var h=g.firstChild;i=i.shadow&&i.lines||0,h&&f+i<h.childNodes.length&&(h=h.childNodes[f+i],h=h&&h.firstChild,h=h&&h.firstChild,h&&(h.opacity=j))}}var v,u=["webkit","Moz","ms","O"],t={},s=function(){var a=F("style",{type:"text/css"});return E(bX.getElementsByTagName("head")[0],a),a.sheet||a.styleSheet}(),e={lines:12,length:7,width:5,radius:10,rotate:0,corners:1,color:"#000",direction:1,speed:1,trail:100,opacity:0.25,fps:20,zIndex:2000000000,className:"spinner",top:"auto",left:"auto",position:"relative"};x.defaults={},A(x.prototype,{spin:function(P){this.stop();var O,N,M=this,L=M.opts,K=M.el=B(F(0,{className:L.className}),{position:L.position,width:0,zIndex:L.zIndex}),J=L.radius+L.length+L.width;if(P&&(P.insertBefore(K,P.firstChild||null),N=z(P),O=z(K),B(K,{left:("auto"==L.left?N.x-O.x+(P.offsetWidth>>1):parseInt(L.left,10)+J)+"px",top:("auto"==L.top?N.y-O.y+(P.offsetHeight>>1):parseInt(L.top,10)+J)+"px"})),K.setAttribute("role","progressbar"),M.lines(K,M.opts),!v){var I,H=0,G=(L.lines-1)*(1-L.direction)/2,m=L.fps,i=m/L.speed,g=(1-L.opacity)/(i*L.trail/100),a=i/L.lines;!function Q(){H++;for(var c=0;c<L.lines;c++){I=Math.max(1-(H+(L.lines-c)*a)%i*g,L.opacity),M.opacity(K,c*L.direction+G,I,L)}M.timeout=M.el&&setTimeout(Q,~~(1000/m))}()}return M},stop:function(){var c=this.el;return c&&(clearTimeout(this.timeout),c.parentNode&&c.parentNode.removeChild(c),this.el=bU),this},lines:function(a,l){function j(f,h){return B(F(),{position:"absolute",width:l.length+l.width+"px",height:l.width+"px",background:f,boxShadow:h,transformOrigin:"left",transform:"rotate("+~~(360/l.lines*d+l.rotate)+"deg) translate("+l.radius+"px,0)",borderRadius:(l.corners*l.width>>1)+"px"})}for(var g,d=0,c=(l.lines-1)*(1-l.direction)/2;d<l.lines;d++){g=B(F(),{position:"absolute",top:1+~(l.width/2)+"px",transform:l.hwaccel?"translate3d(0,0,0)":"",opacity:l.opacity,animation:v&&D(l.opacity,l.trail,c+d*l.direction,l.lines)+" "+1/l.speed+"s linear infinite"}),l.shadow&&E(g,B(j("#000","0 0 4px #000"),{top:"2px"})),E(a,E(g,j(y(l.color,d),"0 0 1px rgba(0,0,0,.1)")))}return a},opacity:function(f,d,g){d<f.childNodes.length&&(f.childNodes[d].style.opacity=g)}});var b=B(F("group"),{behavior:"url(#default#VML)"});return !C(b,"transform")&&b.adj?w():v=C(b,"animation"),x});var a1,aR,aJ,aB,at,ak,cY=bV(bY),cQ=bV(bX),cE="quirks"===bW.hash.replace("#",""),bZ=aX.csstransforms3d,bq=bZ&&!cE,bh=bZ||"CSS1Compat"===bX.compatMode,a5=aP.ok,aV=navigator.userAgent.match(/Android|webOS|iPhone|iPad|iPod|BlackBerry|Windows Phone/i),aN=!bq||aV,aF=navigator.msPointerEnabled,ax="onwheel" in bX.createElement("div")?"wheel":bX.onmousewheel!==bU?"mousewheel":"DOMMouseScroll",ao=250,ae=300,cU=1400,cI=5000,ca=2,bB=64,bl=500,a9=333,aZ="$stageFrame",cA="$navDotFrame",ai="$navThumbFrame",cM="auto",cp=bT([0.1,0,0.25,1]),bN=99999,bn={width:null,minwidth:null,maxwidth:"100%",height:null,minheight:null,maxheight:null,ratio:null,margin:ca,glimpse:0,fit:"contain",nav:"dots",navposition:"bottom",navwidth:null,thumbwidth:bB,thumbheight:bB,thumbmargin:ca,thumbborderwidth:ca,thumbfit:"cover",allowfullscreen:!1,transition:"slide",clicktransition:null,transitionduration:ae,captions:!0,hash:!1,startindex:0,loop:!1,autoplay:!1,stopautoplayontouch:!0,keyboard:!1,arrows:!0,click:!0,swipe:!0,trackpad:!1,controlsonstart:!0,shuffle:!1,direction:"ltr",shadows:!0,spinner:null},be={left:!0,right:!0,down:!1,up:!1,space:!1,home:!1,end:!1};jQuery.Fotorama=function(dq,dj){function di(){bV.each(eb,function(f,e){if(!e.i){e.i=ej++;var i=bu(e.video,!0);if(i){var g={};e.video=i,e.img||e.thumb?e.thumbsReady=!0:g=cC(e,eb,dz),cB(eb,{img:g.img,thumb:g.thumb},e.i,dz)}}})}function df(e){return c[e]||dz.fullScreen}function dc(g){var e="keydown."+aU,n=aU+c6,j="keydown."+n,i="resize."+n+" orientationchange."+n;g?(cQ.on(j,function(s){var f,t;dC&&27===s.keyCode?(f=!0,d1(dC,!0,!0)):(dz.fullScreen||dj.keyboard&&!dz.index)&&(27===s.keyCode?(f=!0,dz.cancelFullScreen()):s.shiftKey&&32===s.keyCode&&df("space")||37===s.keyCode&&df("left")||38===s.keyCode&&df("up")?t="<":32===s.keyCode&&df("space")||39===s.keyCode&&df("right")||40===s.keyCode&&df("down")?t=">":36===s.keyCode&&df("home")?t="<<":35===s.keyCode&&df("end")&&(t=">>")),(f||t)&&b6(s),t&&dz.show({index:t,slow:s.altKey,user:!0})}),dz.index||cQ.off(e).on(e,"textarea, input, select",function(f){!aR.hasClass(aM)&&f.stopPropagation()}),cY.on(i,dz.resize)):(cQ.off(j),cY.off(i))}function da(a){a!==da.f&&(a?(dq.html("").addClass(aU+" "+K).append(Q).before(dE).before(dd),bg(dz)):(Q.detach(),dE.detach(),dd.detach(),dq.html(dZ.urtext).removeClass(K),a4(dz)),dc(a),da.f=a)}function c5(){eb=dz.data=eb||ck(dj.data)||cz(dq),dR=dz.size=eb.length,!eu.ok&&dj.shuffle&&cl(eb),di(),dF=bc(dF),dR&&da(!0)}function c2(){var e=2>dR||dC;r.noMove=e||E,r.noSwipe=e||!dj.swipe,!du&&en.toggleClass(cL,!dj.click&&!r.noMove&&!r.noSwipe),aF&&Q.toggleClass(bk,!r.noSwipe)}function c1(e){e===!0&&(e=""),dj.autoplay=Math.max(+e||cI,1.5*dS)}function cd(){function f(g,i){e[g?"add":"remove"].push(i)}dz.options=dj=ci(dj),E="crossfade"===dj.transition||"dissolve"===dj.transition,v=dj.loop&&(dR>2||E&&(!du||"slide"!==du)),dS=+dj.transitionduration||ae,G="rtl"===dj.direction,c=bV.extend({},dj.keyboard&&be,dj.keyboard);var e={add:[],remove:[]};dR>1?(eq=dj.nav,dO="top"===dj.navposition,e.remove.push(cg),V.toggle(!!dj.arrows)):(eq=!1,V.hide()),c4(),dY=new ag(bV.extend(cW,dj.spinner,cK,{direction:G?-1:1})),P(),p(),dj.autoplay&&c1(dj.autoplay),b=bJ(dj.thumbwidth)||bB,ec=bJ(dj.thumbheight)||bB,eo.ok=dM.ok=dj.trackpad&&!aN,c2(),I(dj,[R]),d6="thumbs"===eq,d6?(er(dR,"navThumb"),ei=eg,dV=ai,cr(dE,bV.Fotorama.jst.style({w:b,h:ec,b:dj.thumbborderwidth,m:dj.thumbmargin,s:c6,q:!bh})),es.addClass(b1).removeClass(cF)):"dots"===eq?(er(dR,"navDot"),ei=dQ,dV=cA,es.addClass(cF).removeClass(b1)):(eq=!1,es.removeClass(b1+" "+cF)),eq&&(dO?A.insertBefore(q):A.insertAfter(q),F.nav=!1,F(ei,ea,"nav")),dp=dj.allowfullscreen,dp?(dA.prependTo(q),Y=a5&&"native"===dp):(dA.detach(),Y=!1),f(E,cT),f(!E,cH),f(!dj.captions,aQ),f(G,a8),f("always"!==dj.arrows,aI),bb=dj.shadows&&!aN,f(!bb,bt),Q.addClass(e.add.join(" ")).removeClass(e.remove.join(" ")),de=bV.extend({},dj)}function cb(e){return 0>e?(dR+e%dR)%dR:e>=dR?e%dR:e}function bc(e){return bP(e,0,dR-1)}function dL(e){return v?cb(e):bc(e)}function dw(e){return e>0||v?e-1:!1}function ds(e){return dR-1>e||v?e+1:!1}function dU(){r.min=v?-1/0:-bF(dR-1,R.w,dj.margin,o),r.max=v?1/0:-bF(0,R.w,dj.margin,o),r.snap=R.w+dj.margin}function J(){d4.min=Math.min(0,R.nw-ea.width()),d4.max=0,ea.toggleClass(cL,!(d4.noMove=d4.min===d4.max))}function d9(g,f,j){if("number"==typeof g){g=new Array(g);var i=!0}return bV.each(g,function(e,w){if(i&&(w=e),"number"==typeof w){var t=eb[cb(w)];if(t){var s="$"+f+"Frame",n=t[s];j.call(this,e,w,t,n,s,n&&n.data())}}})}function dP(f,e,i,g){(!ee||"*"===ee&&g===U)&&(f=bG(dj.width)||bG(f)||bl,e=bG(dj.height)||bG(e)||a9,dz.resize({width:f,ratio:dj.ratio||i||f/e},0,g!==U&&"*"))}function dt(i,e,s,n,j){d9(i,e,function(eE,eD,eC,eB,eA,ez){function ey(w){var t=cb(eD);eh(w,{index:t,src:x,frame:eb[t]})}function ex(){ab.remove(),bV.Fotorama.cache[x]="error",eC.html&&"stage"===e||!g||g===x?(!x||eC.html||cc?"stage"===e&&(eB.trigger("f:load").removeClass(cD+" "+a0).addClass(aj),ey("load"),dP()):(eB.trigger("f:error").removeClass(cD).addClass(a0),ey("error")),ez.state="error",!(dR>1&&eb[eD]===eC)||eC.html||eC.deleted||eC.video||cc||(eC.deleted=!0,dz.splice(eD,1))):(eC[D]=x=g,dt([eD],e,s,n,!0))}function ew(){bV.Fotorama.measures[x]=T.measures=bV.Fotorama.measures[x]||{width:bd.width,height:bd.height,ratio:bd.width/bd.height},dP(T.measures.width,T.measures.height,T.measures.ratio,eD),ab.off("load error").addClass(bo+(cc?" "+bf:"")).prependTo(eB),ct(ab,s||R,n||eC.fit||dj.fit),bV.Fotorama.cache[x]=ez.state="loaded",setTimeout(function(){eB.trigger("f:load").removeClass(cD+" "+a0).addClass(aj+" "+(cc?cN:cs)),"stage"===e?ey("load"):(eC.thumbratio===cM||!eC.thumbratio&&dj.thumbratio===cM)&&(eC.thumbratio=T.measures.ratio,X())},0)}function ev(){var t=10;cw(function(){return !h||!t--&&!aN},function(){ew()})}if(eB){var cc=dz.fullScreen&&eC.full&&eC.full!==eC.img&&!ez.$full&&"stage"===e;if(!ez.$img||j||cc){var bd=new Image,ab=bV(bd),T=ab.data();ez[cc?"$full":"$img"]=ab;var D="stage"===e?cc?"full":"img":"thumb",x=eC[D],g=cc?null:eC["stage"===e?"thumb":"img"];if("navThumb"===e&&(eB=ez.$wrap),!x){return void ex()}bV.Fotorama.cache[x]?!function f(){"error"===bV.Fotorama.cache[x]?ex():"loaded"===bV.Fotorama.cache[x]?setTimeout(ev,0):setTimeout(f,100)}():(bV.Fotorama.cache[x]="*",ab.on("load",ev).on("error",ex)),ez.state="",bd.src=x}}})}function ad(e){d0.append(dY.spin().el).appendTo(e)}function c4(){d0.detach(),dY&&dY.stop()}function O(){var e=c9[aZ];e&&!e.data().state&&(ad(e),e.on("f:load f:error",function(){e.off("f:load f:error"),c4()}))}function z(e){b8(e,d5),b7(e,function(){setTimeout(function(){cj(es)},0),d8({time:dS,guessIndex:bV(this).data().eq,minMax:d4})})}function er(f,e){d9(f,e,function(j,y,x,w,t,s){if(!w){w=x[t]=Q[t].clone(),s=w.data(),s.data=x;var n=w[0];"stage"===e?(x.html&&bV('<div class="'+aD+'"></div>').append(x._html?bV(x.html).removeAttr("id").html(x._html):x.html).appendTo(w),x.caption&&bV(cm(cS,cm(cG,x.caption))).appendTo(w),x.video&&w.addClass(ah).append(L.clone()),b7(n,function(){setTimeout(function(){cj(q)},0),S({index:s.eq,user:!0})}),d3=d3.add(w)):"navDot"===e?(z(n),dQ=dQ.add(w)):"navThumb"===e&&(z(n),s.$wrap=w.children(":first"),eg=eg.add(w),x.video&&w.append(L.clone()))}})}function d7(f,e,g){return f&&f.length&&ct(f,e,g)}function dr(e){d9(e,"stage",function(s,n,T,D,y,x){if(D){var w=cb(n);x.eq=w,W[aZ][w]=D.css(bV.extend({left:E?0:bF(n,R.w,dj.margin,o)},E&&bK(0))),cx(D[0])&&(D.appendTo(en),d1(T.$video));var t=T.fit||dj.fit;d7(x.$img,R,t),d7(x.$full,R,t)}})}function Z(g,e){if("thumbs"===eq&&!isNaN(g)){var j=-g,i=-g+R.nw;eg.each(function(){var f=bV(this),w=f.data(),t=w.eq,s={h:ec},n=(eb[t]||{}).thumbfit||dj.thumbfit;s.w=w.w,w.l+w.w<j||w.l>i||d7(w.$img,s,n)||e&&dt([t],"navThumb",s,n)})}}function F(i,e,s){if(!F[s]){var n="nav"===s&&d6,j=0;e.append(i.filter(function(){for(var t,g=bV(this),y=g.data(),x=0,w=eb.length;w>x;x++){if(y.data===eb[x]){t=!0,y.eq=x;break}}return t||g.remove()&&!1}).sort(function(g,f){return bV(g).data().eq-bV(f).data().eq}).each(function(){if(n){var g=bV(this),f=g.data(),t=Math.round(ec*f.data.thumbratio)||b;f.l=j,f.w=t,g.css({width:t}),j+=t+dj.thumbmargin}})),F[s]=!0}}function dD(e){return e-B>R.w/3}function db(e){return !(v||dF+e&&dF-dR+e||dC)}function P(){var f=db(0),e=db(1);dK.toggleClass(aK,f).attr(b9(f)),dl.toggleClass(aK,e).attr(b9(e))}function p(){eo.ok&&(eo.prevent={"<":db(0),">":db(1)})}function dJ(f){var e,i,g=f.data();return d6?(e=g.l,i=g.w):(e=f.position().left,i=f.width()),{c:e+i/2,min:-e+10*dj.thumbmargin,max:-e+R.w-i-10*dj.thumbmargin}}function dk(f){var e=c9[dV].data();b4(dW,{time:1.2*f,pos:e.l,width:e.w-2*dj.thumbborderwidth})}function d8(j){var i=eb[j.guessIndex][dV];if(i){var x=d4.min!==d4.max,w=j.minMax||x&&dJ(c9[dV]),t=x&&(j.keep&&d8.l?d8.l:bP((j.coo||R.nw/2)-dJ(i).c,w.min,w.max)),s=x&&bP(t,d4.min,d4.max),n=1.1*j.time;b4(ea,{time:n,pos:s||0,onEnd:function(){Z(s,!0)}}),el(es,cq(s,d4.min,d4.max)),d8.l=t}}function ac(){ed(dV),dm[dV].push(c9[dV].addClass(cJ))}function ed(f){for(var e=dm[f];e.length;){e.shift().removeClass(cJ)}}function dv(f){var e=W[f];bV.each(N,function(g,i){delete e[cb(i)]}),bV.each(e,function(g,i){delete e[g],i.detach()})}function dy(f){o=em=dF;var e=c9[aZ];e&&(ed(aZ),dm[aZ].push(e.addClass(cJ)),f||dz.show.onEnd(!0),bz(en,0,!0),dv(aZ),dr(N),dU(),J())}function I(f,e){f&&bV.each(e,function(a,g){g&&bV.extend(g,{width:f.width||g.width,height:f.height,minwidth:f.minwidth,maxwidth:f.maxwidth,minheight:f.minheight,maxheight:f.maxheight,ratio:ch(f.ratio)})})}function eh(a,e){dq.trigger(aU+":"+a,[dz,e])}function dX(){clearTimeout(dB.t),h=1,dj.stopautoplayontouch?dz.stopAutoplay():dx=!0}function dB(){dj.stopautoplayontouch||(c8(),M()),dB.t=setTimeout(function(){h=0},ae+ao)}function c8(){dx=!(!dC&&!c3)}function M(){if(clearTimeout(M.t),!dj.autoplay||dx){return void (dz.autoplay&&(dz.autoplay=!1,eh("stopautoplay")))}dz.autoplay||(dz.autoplay=!0,eh("startautoplay"));var f=dF,e=c9[aZ].data();cw(function(){return e.state||f!==dF},function(){M.t=setTimeout(function(){dx||f!==dF||dz.show(v?b5(!G):cb(dF+(G?-1:1)))},dj.autoplay)})}function m(){dz.fullScreen&&(dz.fullScreen=!1,a5&&aP.cancel(k),aR.removeClass(aM),a1.removeClass(aM),dq.removeClass(bm).insertAfter(dd),R=bV.extend({},H),d1(dC,!0,!0),ep("x",!1),dz.resize(),dt(N,"stage"),cj(cY,d,dI),eh("fullscreenexit"))}function el(f,e){bb&&(f.removeClass(af+" "+cV),e&&!dC&&f.addClass(e.replace(/^|\s/g," "+ap+"--")))}function d1(f,e,g){e&&(Q.removeClass(aa),dC=!1,c2()),f&&f!==dC&&(f.remove(),eh("unloadvideo")),g&&(c8(),M())}function dG(e){Q.toggleClass(b3,e)}function dg(f){if(!r.flow){var e=f?f.pageX:dg.x,g=e&&!db(dD(e))&&dj.click;dg.p!==g&&q.toggleClass(a2,g)&&(dg.p=g,dg.x=e)}}function S(e){clearTimeout(S.t),dj.clicktransition&&dj.clicktransition!==dj.transition?(du=dj.transition,dz.setOptions({transition:dj.clicktransition}),S.t=setTimeout(function(){dz.show(e)},10)):dz.show(e)}function u(g,e){var j=g.target,i=bV(j);i.hasClass(am)?dz.playVideo():j===c7?dz.toggleFullScreen():dC?j===ek&&d1(dC,!0,!0):e?dG():dj.click&&S({index:g.shiftKey||b5(dD(g._x)),slow:g.altKey,user:!0})}function ep(f,e){r[f]=d4[f]=e}function d5(f){var e=bV(this).data().eq;S({index:e,slow:f.altKey,user:!0,coo:f._x-es.offset().left})}function dN(e){S({index:V.index(this)?">":"<",slow:e.altKey,user:!0})}function dn(e){b7(e,function(){cj(q),setTimeout(function(){cj(q)},0),dG(!1)})}function X(){X.ok;if(c5(),cd(),!X.i){X.i=!0;var e=dj.startindex;(e||dj.hash&&bW.hash)&&(U=co(e||bW.hash.replace(/^#/,""),eb,0===dz.index||e,e)),dF=o=em=d2=U=dL(U)||0}if(dR){if(C()){return}dC&&d1(dC,!0),N=[],dv(aZ),X.ok=!0,dz.show({index:dF,time:0}),dz.resize()}else{dz.destroy()}}function C(){return !C.f===G?(C.f=G,dF=dR-1-dF,dz.reverse(),!0):void 0}function eu(){eu.ok||(eu.ok=!0,eh("ready"))}a1=bV("html"),aR=bV("body");var eb,dR,ei,dY,dC,c9,N,o,em,d2,dH,dh,U,v,eq,d6,dO,dp,Y,E,b,ec,dS,du,bb,G,c,ee,dI,d,dT,dx,c3,H,h,ef,dV,dz=this,c6=bV.now(),K=aU+c6,k=dq[0],ej=1,dZ=dq.data(),dE=bV("<style></style>"),dd=bV(cm(bE)),Q=bV(cm(aE)),q=bV(cm(aA)).appendTo(Q),en=(q[0],bV(cm(cX)).appendTo(q)),d3=bV(),dK=bV(cm(aS+" "+aC+bs)),dl=bV(cm(aS+" "+au+bs)),V=dK.add(dl).appendTo(q),A=bV(cm(cZ)),es=bV(cm(al)).appendTo(A),ea=bV(cm(cR)).appendTo(es),dQ=bV(),eg=bV(),dW=(en.data(),ea.data(),bV(cm(aL)).appendTo(ea)),dA=bV(cm(ba+bs)),c7=dA[0],L=bV(cm(am)),l=bV(cm(c0)).appendTo(q),ek=l[0],d0=bV(cm(b2)),dF=!1,de={},R={},r={},eo={},d4={},dM={},dm={},W={},B=0,et=[];Q[aZ]=bV(cm(ar)),Q[ai]=bV(cm(br+" "+a6+bs,cm(aT))),Q[cA]=bV(cm(br+" "+bi+bs,cm(a3))),dm[aZ]=[],dm[ai]=[],dm[cA]=[],W[aZ]={},Q.addClass(bq?an:aw).toggleClass(b3,!dj.controlsonstart),dZ.fotorama=this,dz.startAutoplay=function(e){return dz.autoplay?this:(dx=c3=!1,c1(e||dj.autoplay),M(),this)},dz.stopAutoplay=function(){return dz.autoplay&&(dx=c3=!0,M()),this},dz.show=function(bd){var ab;"object"!=typeof bd?(ab=bd,bd={}):ab=bd.index,ab=">"===ab?em+1:"<"===ab?em-1:"<<"===ab?0:">>"===ab?dR-1:ab,ab=isNaN(ab)?co(ab,eb,!0):ab,ab="undefined"==typeof ab?dF||0:ab,dz.activeIndex=dF=dL(ab),dH=dw(dF),dh=ds(dF),N=[dF,dH,dh],em=v?ab:dF;var T=Math.abs(d2-em),D=by(bd.time,function(){return Math.min(dS*(1+(T-1)/12),2*dS)}),y=bd.overPos;bd.slow&&(D*=10);var x=c9;dz.activeFrame=c9=eb[dF];var w=x===c9;d1(dC,c9.i!==eb[cb(o)].i),er(N,"stage"),dr(aN?[em]:[em,dw(em),ds(em)]),ep("go",!0),w||eh("show",{user:bd.user,time:D}),dx=!0;var t=dz.show.onEnd=function(a){if(!t.ok){if(t.ok=!0,a||dy(!0),!w&&(eh("showend",{user:bd.user}),!a&&du&&du!==dj.transition)){return dz.setOptions({transition:du}),void (du=!1)}O(),dt(N,"stage"),ep("go",!1),p(),dg(),c8(),M()}};if(E){var s=c9[aZ],n=dF!==d2?eb[d2][aZ]:null;cP(s,n,d3,{time:D,method:dj.transition,onEnd:t},et)}else{b4(en,{pos:-bF(em,R.w,dj.margin,o),overPos:y,time:D,onEnd:t})}if(P(),eq){ac();var e=bc(dF+bP(em-d2,-1,1));d8({time:D,coo:e!==dF&&bd.coo,guessIndex:"undefined"!=typeof bd.coo?e:dF,keep:w}),d6&&dk(D)}return dT="undefined"!=typeof d2&&d2!==dF,d2=dF,dj.hash&&dT&&!dz.eq&&cv(c9.id||dF+1),this},dz.requestFullScreen=function(){return dp&&!dz.fullScreen&&(dI=cY.scrollTop(),d=cY.scrollLeft(),cj(cY),ep("x",!0),H=bV.extend({},R),dq.addClass(bm).appendTo(aR.addClass(aM)),a1.addClass(aM),d1(dC,!0,!0),dz.fullScreen=!0,Y&&aP.request(k),dz.resize(),dt(N,"stage"),O(),eh("fullscreenenter")),this},dz.cancelFullScreen=function(){return Y&&aP.is()?aP.cancel(bX):m(),this},dz.toggleFullScreen=function(){return dz[(dz.fullScreen?"cancel":"request")+"FullScreen"]()},cf(bX,aP.event,function(){!eb||aP.is()||dC||m()}),dz.resize=function(j){if(!eb){return this}var e=arguments[1]||0,x=arguments[2];I(dz.fullScreen?{width:"100%",maxwidth:null,minwidth:null,height:"100%",maxheight:null,minheight:null}:ci(j),[R,x||dz.fullScreen||dj]);var w=R.width,t=R.height,s=R.ratio,n=cY.height()-(eq?es.height():0);return bG(w)&&(Q.addClass(aY).css({width:w,minWidth:R.minwidth||0,maxWidth:R.maxwidth||bN}),w=R.W=R.w=Q.width(),R.nw=eq&&bH(dj.navwidth,w)||w,dj.glimpse&&(R.w-=Math.round(2*(bH(dj.glimpse,w)||0))),en.css({width:R.w,marginLeft:(R.W-R.w)/2}),t=bH(t,n),t=t||s&&w/s,t&&(w=Math.round(w),t=R.h=Math.round(bP(t,bH(R.minheight,n),bH(R.maxheight,n))),q.stop().animate({width:w,height:t},e,function(){Q.removeClass(aY)}),dy(),eq&&(es.stop().animate({width:R.nw},e),d8({guessIndex:dF,time:e,keep:!0}),d6&&F.nav&&dk(e)),ee=x||!0,eu())),B=q.offset().left,this},dz.setOptions=function(e){return bV.extend(dj,e),X(),this},dz.shuffle=function(){return eb&&cl(eb)&&X(),this},dz.destroy=function(){return dz.cancelFullScreen(),dz.stopAutoplay(),eb=dz.data=null,da(),N=[],dv(aZ),X.ok=!1,this},dz.playVideo=function(){var f=c9,e=f.video,g=dF;return"object"==typeof e&&f.videoReady&&(Y&&dz.fullScreen&&dz.cancelFullScreen(),cw(function(){return !aP.is()||g!==dF},function(){g===dF&&(f.$video=f.$video||bV(bV.Fotorama.jst.video(e)),f.$video.appendTo(f[aZ]),Q.addClass(aa),dC=f.$video,c2(),V.blur(),dA.blur(),eh("loadvideo"))})),this},dz.stopVideo=function(){return d1(dC,!0,!0),this},q.on("mousemove",dg),r=cu(en,{onStart:dX,onMove:function(f,e){el(q,e.edge)},onTouchEnd:dB,onEnd:function(f){el(q);var e=(aF&&!ef||f.touch)&&dj.arrows&&"always"!==dj.arrows;if(f.moved||e&&f.pos!==f.newPos&&!f.control){var g=bD(f.newPos,R.w,dj.margin,o);dz.show({index:g,time:E?dS:f.time,overPos:f.overPos,user:!0})}else{f.aborted||f.control||u(f.startEvent,e)}},timeLow:1,timeHigh:1,friction:2,select:"."+cg+", ."+cg+" *",$wrap:q}),d4=cu(ea,{onStart:dX,onMove:function(f,e){el(es,e.edge)},onTouchEnd:dB,onEnd:function(f){function e(){d8.l=f.newPos,c8(),M(),Z(f.newPos,!0)}if(f.moved){f.pos!==f.newPos?(dx=!0,b4(ea,{time:f.time,pos:f.newPos,overPos:f.overPos,onEnd:e}),Z(f.newPos),bb&&el(es,cq(f.newPos,d4.min,d4.max))):e()}else{var g=f.$target.closest("."+br,ea)[0];g&&d5.call(g,f.startEvent)}},timeLow:0.5,timeHigh:2,friction:5,$wrap:es}),eo=bS(q,{shift:!0,onEnd:function(f,e){dX(),dB(),dz.show({index:e,slow:f.altKey})}}),dM=bS(es,{onEnd:function(f,e){dX(),dB();var g=bz(ea)+0.25*e;ea.css(bL(bP(g,d4.min,d4.max))),bb&&el(es,cq(g,d4.min,d4.max)),dM.prevent={"<":g>=d4.max,">":g<=d4.min},clearTimeout(dM.t),dM.t=setTimeout(function(){d8.l=g,Z(g,!0)},ao),Z(g)}}),Q.hover(function(){setTimeout(function(){h||dG(!(ef=!0))},0)},function(){ef&&dG(!(ef=!1))}),cn(V,function(e){b6(e),dN.call(this,e)},{onStart:function(){dX(),r.control=!0},onTouchEnd:dB}),V.each(function(){b8(this,function(e){dN.call(this,e)}),dn(this)}),b8(c7,dz.toggleFullScreen),dn(c7),bV.each("load push pop shift unshift reverse sort splice".split(" "),function(f,e){dz[e]=function(){return eb=eb||[],"load"!==e?Array.prototype[e].apply(eb,arguments):arguments[0]&&"object"==typeof arguments[0]&&arguments[0].length&&(eb=ck(arguments[0])),X(),dz}}),X()},bV.fn.fotorama=function(a){return this.each(function(){var i=this,h=bV(this),d=h.data(),b=d.fotorama;b?b.setOptions(a,!0):cw(function(){return !cy(i)},function(){d.urtext=h.html(),new bV.Fotorama(h,bV.extend({},bn,bY.fotoramaDefaults,a,d))})})},bV.Fotorama.instances=[],bV.Fotorama.cache={},bV.Fotorama.measures={},bV=bV||{},bV.Fotorama=bV.Fotorama||{},bV.Fotorama.jst=bV.Fotorama.jst||{},bV.Fotorama.jst.style=function(e){var d,f="";a7.escape;return f+=".fotorama"+(null==(d=e.s)?"":d)+" .fotorama__nav--thumbs .fotorama__nav__frame{\npadding:"+(null==(d=e.m)?"":d)+"px;\nheight:"+(null==(d=e.h)?"":d)+"px}\n.fotorama"+(null==(d=e.s)?"":d)+" .fotorama__thumb-border{\nheight:"+(null==(d=e.h-e.b*(e.q?0:2))?"":d)+"px;\nborder-width:"+(null==(d=e.b)?"":d)+"px;\nmargin-top:"+(null==(d=e.m)?"":d)+"px}"},bV.Fotorama.jst.video=function(f){function e(){h+=g.call(arguments,"")}var h="",g=(a7.escape,Array.prototype.join);return h+='<div class="fotorama__video"><iframe src="',e(("youtube"==f.type?f.p+"youtube.com/embed/"+f.id+"?autoplay=1":"vimeo"==f.type?f.p+"player.vimeo.com/video/"+f.id+"?autoplay=1&badge=0":f.id)+(f.s&&"custom"!=f.type?"&"+f.s:"")),h+='" frameborder="0" allowfullscreen></iframe></div>\n'},bV(function(){bV("."+aU+':not([data-auto="false"])').fotorama(),"https://"===bw().p||bY.blockFotoramaData||bV("body").append("")})}(window,document,location,"undefined"!=typeof jQuery&&jQuery);
(function(e,c,a,g){var d="floatlabel",f={slideInput:true,labelStartTop:"0",labelEndTop:"-20px",paddingOffset:"0",transitionDuration:0.1,transitionEasing:"ease-in-out",labelClass:"",typeMatches:/text|password|email|number|search|url|tel/};function b(i,h){this.$element=e(i);this.settings=e.extend({},f,h);this.init()}b.prototype={init:function(){var q=this,i=this.settings,p=i.transitionDuration,m=i.transitionEasing,h=this.$element;var j={"-webkit-transition":"all "+p+"s "+m,"-moz-transition":"all "+p+"s "+m,"-o-transition":"all "+p+"s "+m,"-ms-transition":"all "+p+"s "+m,transition:"all "+p+"s "+m};if(h.prop("tagName").toUpperCase()!=="INPUT"){return}if(!i.typeMatches.test(h.attr("type"))){return}var l=h.attr("id");if(!l){l=Math.floor(Math.random()*100)+1;h.attr("id","i-"+l)}var n=h.attr("placeholder");var o=h.data("label");var k=h.data("class");if(!n||n===""){n="Нет плейсхолдера!"}if(!o||o===""){o=n}if(!k){k=""}this.inputPaddingTop=parseFloat(h.css("padding-top"))+parseFloat(i.paddingOffset);h.wrap('<div class="floatlabel-wrapper" style="position:relative"></div>');h.after('<label for="'+l+'" class="label-floatlabel '+i.labelClass+" "+k+'">'+o+"</label>");this.$label=h.next("label");this.$label.css({position:"absolute",top:i.labelStartTop,left:"20px",display:"none","-moz-opacity":"0","-khtml-opacity":"0","-webkit-opacity":"0",opacity:"0","font-size":"12px","font-weight":"normal",color:"rgba(0,0,0,0.2)"});if(!i.slideInput){h.css({"padding-top":this.inputPaddingTop})}h.on("keyup blur change",function(r){q.checkValue(r)});h.on("blur",function(){h.next("label").css({color:"rgba(0,0,0,0.2)"})});h.on("focus",function(){h.next("label").css({color:"rgba(0,0,0,0.6)"})});c.setTimeout(function(){q.$label.css(j);q.$element.css(j)},100);this.checkValue()},checkValue:function(k){if(k){var j=k.keyCode||k.which;if(j===9){return}}var i=this.$element,h=i.data("flout");if(i.val()!==""){i.data("flout","1")}if(i.val()===""){i.data("flout","0")}if(i.data("flout")==="1"&&h!=="1"){this.showLabel()}if(i.data("flout")==="0"&&h!=="0"){this.hideLabel()}},showLabel:function(){var h=this;h.$label.css({display:"block"});c.setTimeout(function(){h.$label.css({top:h.settings.labelEndTop,"-moz-opacity":"1","-khtml-opacity":"1","-webkit-opacity":"1",opacity:"1"});if(h.settings.slideInput){h.$element.css({"padding-top":h.inputPaddingTop})}h.$element.addClass("active-floatlabel")},50)},hideLabel:function(){var h=this;h.$label.css({top:h.settings.labelStartTop,"-moz-opacity":"0","-khtml-opacity":"0","-webkit-opacity":"0",opacity:"0"});if(h.settings.slideInput){h.$element.css({"padding-top":parseFloat(h.inputPaddingTop)-parseFloat(this.settings.paddingOffset)})}h.$element.removeClass("active-floatlabel");c.setTimeout(function(){h.$label.css({display:"none"})},h.settings.transitionDuration*1000)}};e.fn[d]=function(h){return this.each(function(){if(!e.data(this,"plugin_"+d)){e.data(this,"plugin_"+d,new b(this,h))}})}})(jQuery,window,document);
