...
(function(e,c,a,g){var d="floatlabel",f={slideInput:true,labelStartTop:"0",labelEndTop:"72px",paddingOffset:"0",transitionDuration:0.1,transitionEasing:"ease-in-out",labelClass:"",typeMatches:/text|password|email|number|search|url|tel/};function b(i,h){this.$element=e(i);this.settings=e.extend({},f,h);this.init()}b.prototype={init:function(){var q=this,i=this.settings,p=i.transitionDuration,m=i.transitionEasing,h=this.$element;var j={"-webkit-transition":"all "+p+"s "+m,"-moz-transition":"all "+p+"s "+m,"-o-transition":"all "+p+"s "+m,"-ms-transition":"all "+p+"s "+m,transition:"all "+p+"s "+m};if(h.prop("tagName").toUpperCase()!=="INPUT"){return}if(!i.typeMatches.test(h.attr("type"))){return}var l=h.attr("id");if(!l){l=Math.floor(Math.random()*100)+1;h.attr("id","i-"+l)}var n=h.attr("placeholder");var o=h.data("label");var k=h.data("class");if(!n||n===""){n="Нет плейсхолдера!"}if(!o||o===""){o=n}if(!k){k=""}this.inputPaddingTop=parseFloat(h.css("padding-top"))+parseFloat(i.paddingOffset);h.wrap('<div class="floatlabel-wrapper" style="position:relative"></div>');h.after('<label for="'+l+'" class="label-floatlabel '+i.labelClass+" "+k+'">'+o+"</label>");this.$label=h.next("label");this.$label.css({position:"absolute",bottom:i.labelStartTop,left:"20px",display:"none","-moz-opacity":"0","-khtml-opacity":"0","-webkit-opacity":"0",opacity:"0","font-size":"12px","line-height":"16px",height:"16px","font-weight":"normal",color:"rgba(0,0,0,0.4)"});if(!i.slideInput){h.css({"padding-top":this.inputPaddingTop})}h.on("keyup blur change",function(r){q.checkValue(r)});h.on("blur",function(){h.next("label").css({color:"rgba(0,0,0,0.4)"})});h.on("focus",function(){h.next("label").css({color:"rgba(0,0,0,0.6)"})});c.setTimeout(function(){q.$label.css(j);q.$element.css(j)},100);this.checkValue()},checkValue:function(k){if(k){var j=k.keyCode||k.which;if(j===9){return}}var i=this.$element,h=i.data("flout");if(i.val()!==""){i.data("flout","1")}if(i.val()===""){i.data("flout","0")}if(i.data("flout")==="1"&&h!=="1"){this.showLabel()}if(i.data("flout")==="0"&&h!=="0"){this.hideLabel()}},showLabel:function(){var h=this;h.$label.css({display:"block"});c.setTimeout(function(){h.$label.css({bottom:h.settings.labelEndTop,"-moz-opacity":"1","-khtml-opacity":"1","-webkit-opacity":"1",opacity:"1"});if(h.settings.slideInput){h.$element.css({"padding-top":h.inputPaddingTop})}h.$element.addClass("active-floatlabel")},50)},hideLabel:function(){var h=this;h.$label.css({bottom:h.settings.labelStartTop,"-moz-opacity":"0","-khtml-opacity":"0","-webkit-opacity":"0",opacity:"0"});if(h.settings.slideInput){h.$element.css({"padding-top":parseFloat(h.inputPaddingTop)-parseFloat(this.settings.paddingOffset)})}h.$element.removeClass("active-floatlabel");c.setTimeout(function(){h.$label.css({display:"none"})},h.settings.transitionDuration*1000)}};e.fn[d]=function(h){return this.each(function(){if(!e.data(this,"plugin_"+d)){e.data(this,"plugin_"+d,new b(this,h))}})}})(jQuery,window,document);
...
(function(g,k){var t=0,C=(k.navigator.userAgent||k.navigator.vendor||k.opera),h=/Firefox/i.test(C),p=/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(C),y=(h&&p),u=null;var c={callback:g.noop,cover:false,customClass:"",label:"",external:false,links:false,mobile:false,trim:0};var w={defaults:function(F){c=g.extend(c,F||{});return(typeof this==="object")?g(this):true},disable:function(F){return g(this).each(function(I,G){var J=g(G).parent(".selecter").data("selecter");if(J){if(typeof F!=="undefined"){var H=J.$items.index(J.$items.filter("[data-value="+F+"]"));J.$items.eq(H).addClass("disabled");J.$options.eq(H).prop("disabled",true)}else{if(J.$selecter.hasClass("open")){J.$selecter.find(".selecter-selected").trigger("click.selecter")}J.$selecter.addClass("disabled");J.$select.prop("disabled",true)}}})},destroy:function(){return g(this).each(function(G,F){var H=g(F).parent(".selecter").data("selecter");if(H){if(H.$selecter.hasClass("open")){H.$selecter.find(".selecter-selected").trigger("click.selecter")}if(g.fn.scroller!==undefined){H.$selecter.find(".selecter-options").scroller("destroy")}H.$select[0].tabIndex=H.tabIndex;H.$select.find(".selecter-placeholder").remove();H.$selected.remove();H.$itemsWrapper.remove();H.$selecter.off(".selecter");H.$select.off(".selecter").removeClass("selecter-element").show().unwrap()}})},enable:function(F){return g(this).each(function(I,G){var J=g(G).parent(".selecter").data("selecter");if(J){if(typeof F!=="undefined"){var H=J.$items.index(J.$items.filter("[data-value="+F+"]"));J.$items.eq(H).removeClass("disabled");J.$options.eq(H).prop("disabled",false)}else{J.$selecter.removeClass("disabled");J.$select.prop("disabled",false)}}})},refresh:function(){return w.update.apply(g(this))},update:function(){return g(this).each(function(H,F){var I=g(F).parent(".selecter").data("selecter");if(I){var G=I.index;I.$allOptions=I.$select.find("option, optgroup");I.$options=I.$allOptions.filter("option");I.index=-1;G=I.$options.index(I.$options.filter(":selected"));f(I);if(!I.multiple){x(G,I)}}})}};function j(H){H=g.extend({},c,H||{});if(u===null){u=g("body")}var I=g(this);for(var F=0,G=I.length;F<G;F++){d(I.eq(F),H)}return I}function d(I,F){if(!I.hasClass("selecter-element")){F=g.extend({},F,I.data("selecter-options"));F.multiple=I.prop("multiple");F.disabled=I.is(":disabled");if(F.external){F.links=true}var Q=I.find("[selected]").not(":disabled"),O=I.find("option").index(Q);if(!F.multiple&&F.label!==""){I.prepend('<option value="" class="selecter-placeholder" selected>'+F.label+"</option>");if(O>-1){O++}}else{F.label=""}var H=I.find("option, optgroup"),M=H.filter("option");if(!Q.length){Q=M.eq(0)}var N=(O>-1)?O:0,P=(F.label!=="")?F.label:Q.text(),J="div";F.tabIndex=I[0].tabIndex;I[0].tabIndex=-1;var R="",G="";G+="<"+J+' class="selecter '+F.customClass;if(p){G+=" mobile"}else{if(F.cover){G+=" cover"}}if(F.multiple){G+=" multiple"}else{G+=" closed"}if(F.disabled){G+=" disabled"}G+='" tabindex="'+F.tabIndex+'">';G+="</"+J+">";if(!F.multiple){R+='<span class="selecter-selected">';R+=g("<span></span>").text(i(P,F.trim)).html();R+="</span>"}R+='<div class="selecter-options">';R+="</div>";I.addClass("selecter-element").wrap(G).after(R);var L=I.parent(".selecter"),K=g.extend({$select:I,$allOptions:H,$options:M,$selecter:L,$selected:L.find(".selecter-selected"),$itemsWrapper:L.find(".selecter-options"),index:-1,guid:t++},F);f(K);if(!K.multiple){x(N,K)}if(g.fn.scroller!==undefined){K.$itemsWrapper.scroller()}K.$selecter.on("touchstart.selecter",".selecter-selected",K,m).on("click.selecter",".selecter-selected",K,v).on("click.selecter",".selecter-item",K,b).on("close.selecter",K,n).data("selecter",K);K.$select.on("change.selecter",K,B);if(!p){K.$selecter.on("focusin.selecter",K,r).on("blur.selecter",K,z);K.$select.on("focusin.selecter",K,function(S){S.data.$selecter.trigger("focus")})}}}function f(L){var H="",K=(L.links)?"a":"span",F=0;for(var G=0,J=L.$allOptions.length;G<J;G++){var M=L.$allOptions.eq(G);if(M[0].tagName==="OPTGROUP"){H+='<span class="selecter-group';if(M.is(":disabled")){H+=" disabled"}H+='">'+M.attr("label")+"</span>"}else{var I=M.val();if(!M.attr("value")){M.attr("value",I)}H+="<"+K+' class="selecter-item';if(M.hasClass("selecter-placeholder")){H+=" placeholder"}if(M.is(":selected")){H+=" selected"}if(M.is(":disabled")){H+=" disabled"}H+='" ';if(L.links){H+='href="'+I+'"'}else{H+='data-value="'+I+'"'}H+=">"+g("<span></span>").text(i(M.text(),L.trim)).html()+"</"+K+">";F++}}L.$itemsWrapper.html(H);L.$items=L.$selecter.find(".selecter-item")}function m(G){G.stopPropagation();var F=G.data;F.touchStartEvent=G.originalEvent;F.touchStartX=F.touchStartEvent.touches[0].clientX;F.touchStartY=F.touchStartEvent.touches[0].clientY;F.$selecter.on("touchmove.selecter",".selecter-selected",F,o).on("touchend.selecter",".selecter-selected",F,l)}function o(G){var F=G.data,H=G.originalEvent;if(Math.abs(H.touches[0].clientX-F.touchStartX)>10||Math.abs(H.touches[0].clientY-F.touchStartY)>10){F.$selecter.off("touchmove.selecter touchend.selecter")}}function l(G){var F=G.data;F.touchStartEvent.preventDefault();F.$selecter.off("touchmove.selecter touchend.selecter");v(G)}function v(I){I.preventDefault();I.stopPropagation();var H=I.data;if(!H.$select.is(":disabled")){g(".selecter").not(H.$selecter).trigger("close.selecter",[H]);if(!H.mobile&&p&&!y){var G=H.$select[0];if(k.document.createEvent){var F=k.document.createEvent("MouseEvents");F.initMouseEvent("mousedown",false,true,k,0,0,0,0,0,false,false,false,false,0,null);G.dispatchEvent(F)}else{if(G.fireEvent){G.fireEvent("onmousedown")}}}else{if(H.$selecter.hasClass("closed")){s(I)}else{if(H.$selecter.hasClass("open")){n(I)}}}}}function s(H){H.preventDefault();H.stopPropagation();var G=H.data;if(!G.$selecter.hasClass("open")){var K=G.$selecter.offset(),J=u.outerHeight(),F=G.$itemsWrapper.outerHeight(true),I=(G.index>=0)?G.$items.eq(G.index).position():{left:0,top:0};if(K.top+F>J){G.$selecter.addClass("bottom")}G.$itemsWrapper.show();G.$selecter.removeClass("closed").addClass("open");u.on("click.selecter-"+G.guid,":not(.selecter-options)",G,D);E(G)}}function D(F){F.preventDefault();F.stopPropagation();if(g(F.currentTarget).parents(".selecter").length===0){n(F)}}function n(G){G.preventDefault();G.stopPropagation();var F=G.data;if(F.$selecter.hasClass("open")){F.$itemsWrapper.hide();F.$selecter.removeClass("open bottom").addClass("closed");u.off(".selecter-"+F.guid)}}function b(I){I.preventDefault();I.stopPropagation();var F=g(this),H=I.data;if(!H.$select.is(":disabled")){if(H.$itemsWrapper.is(":visible")){var G=H.$items.index(F);if(G!==H.index){x(G,H);A(H)}}if(!H.multiple){n(I)}}}function B(J,G){var F=g(this),I=J.data;if(!G&&!I.multiple){var H=I.$options.index(I.$options.filter("[value='"+a(F.val())+"']"));x(H,I);A(I)}}function r(G){G.preventDefault();G.stopPropagation();var F=G.data;if(!F.$select.is(":disabled")&&!F.multiple){F.$selecter.addClass("focus").on("keydown.selecter-"+F.guid,F,q);g(".selecter").not(F.$selecter).trigger("close.selecter",[F])}}function z(I,F,G){I.preventDefault();I.stopPropagation();var H=I.data;H.$selecter.removeClass("focus").off("keydown.selecter-"+H.guid);g(".selecter").not(H.$selecter).trigger("close.selecter",[H])}function q(L){var K=L.data;if(L.keyCode===13){if(K.$selecter.hasClass("open")){n(L);x(K.index,K)}A(K)}else{if(L.keyCode!==9&&(!L.metaKey&&!L.altKey&&!L.ctrlKey&&!L.shiftKey)){L.preventDefault();L.stopPropagation();var J=K.$items.length-1,G=(K.index<0)?0:K.index;if(g.inArray(L.keyCode,(h)?[38,40,37,39]:[38,40])>-1){G=G+((L.keyCode===38||(h&&L.keyCode===37))?-1:1);if(G<0){G=0}if(G>J){G=J}}else{var F=String.fromCharCode(L.keyCode).toUpperCase(),I,H;for(H=K.index+1;H<=J;H++){I=K.$options.eq(H).text().charAt(0).toUpperCase();if(I===F){G=H;break}}if(G<0||G===K.index){for(H=0;H<=J;H++){I=K.$options.eq(H).text().charAt(0).toUpperCase();if(I===F){G=H;break}}}}if(G>=0){x(G,K);E(K)}}}}function x(I,K){var G=K.$items.eq(I),H=G.hasClass("selected"),F=G.hasClass("disabled");if(!F){if(K.multiple){if(H){K.$options.eq(I).prop("selected",null);G.removeClass("selected")}else{K.$options.eq(I).prop("selected",true);G.addClass("selected")}}else{if(I>-1&&I<K.$items.length){var J=G.html(),L=G.data("value");K.$selected.html(J).removeClass("placeholder");K.$items.filter(".selected").removeClass("selected");K.$select[0].selectedIndex=I;G.addClass("selected");K.index=I}else{if(K.label!==""){K.$selected.html(K.label)}}}}}function E(G){var F=G.$items.eq(G.index),H=(G.index>=0&&!F.hasClass("placeholder"))?F.position():{left:0,top:0};if(g.fn.scroller!==undefined){G.$itemsWrapper.scroller("scroll",(G.$itemsWrapper.find(".scroller-content").scrollTop()+H.top),0).scroller("reset")}else{G.$itemsWrapper.scrollTop(G.$itemsWrapper.scrollTop()+H.top)}}function A(F){if(F.links){e(F)}else{F.callback.call(F.$selecter,F.$select.val(),F.index);F.$select.trigger("change",[true])}}function e(G){var F=G.$select.val();if(G.external){k.open(F)}else{k.location.href=F}}function i(G,F){if(F===0){return G}else{if(G.length>F){return G.substring(0,F)+"..."}else{return G}}}function a(F){return(typeof F==="string")?F.replace(/([;&,\.\+\*\~':"\!\^#$%@\[\]\(\)=>\|])/g,"\\$1"):F}g.fn.selecter=function(F){if(w[F]){return w[F].apply(this,Array.prototype.slice.call(arguments,1))}else{if(typeof F==="object"||!F){return j.apply(this,arguments)}}return this};g.selecter=function(F){if(F==="defaults"){w.defaults.apply(this,Array.prototype.slice.call(arguments,1))}}})(jQuery,window);
